...
namespace Redemption.Backgrounds.Skies
{
	public class StarGodSky : CustomSky
	{
		...
		{
			Texture2D SkyTex = this.mod.GetTexture("Backgrounds/Skies/StarGodSky");
			if (maxDepth >= 3.4028235E+38f && minDepth < 3.4028235E+38f && !Main.dayTime)
			{
				...
				spriteBatch.Draw(SkyTex, SkyPos, null, Color.White, 0f, new Vector2((float)(SkyTex.Width >> 1), (float)(SkyTex.Height >> 1)), 1f, SpriteEffects.None, 1f);
