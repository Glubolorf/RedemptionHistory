...
namespace Redemption.Items.DruidDamageClass
{
	public class AncientWorldStave2 : DruidDamageItem
	{
		...
		public override void SafeSetDefaults()
		{
			...
			base.item.shoot = ModContent.ProjectileType<WorldTree2>();
