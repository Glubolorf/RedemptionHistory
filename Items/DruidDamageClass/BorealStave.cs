...
namespace Redemption.Items.DruidDamageClass
{
	public class BorealStave : DruidStave
	{
		...
		public override void SafeSetDefaults()
		{
			...
			base.item.shoot = base.mod.ProjectileType("KingsOakShot3");
			base.item.shootSpeed = 8f;
			this.defaultShoot = base.mod.ProjectileType("KingsOakShot3");
			this.guardianBuffID = base.mod.BuffType("NatureGuardian23Buff");
			this.guardianProjectileID = base.mod.ProjectileType("NatureGuardian23");
