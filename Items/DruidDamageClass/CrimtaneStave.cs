...
namespace Redemption.Items.DruidDamageClass
{
	public class CrimtaneStave : DruidDamageItem
	{
		public override void SetStaticDefaults()
		{
			...
			base.Tooltip.SetDefault("[c/91dc16:---Druid Class---]\nShoots a Crimson Blast\nRight-clicking will summon a Crimson Fairy [c/bee7c9:(25 Second Duration)]\n[c/71ee8d:-Guardian Info-]\n[c/a0db98:Type:] Fairy\n[c/98dbc3:Special Ability:] Swift-Swing/Crimson Aura\n[c/98c1db:Effects:] Staves swing a lot faster, Mobility Enhancement while in Crimson");
		}
		...
		public override bool CanUseItem(Player player)
		{
			...
			{
				base.item.mana = 1;
				base.item.buffType = base.mod.BuffType("NatureGuardian9Buff");
				...
				base.item.shoot = base.mod.ProjectileType("NatureGuardian9");
