...
{
	public class CrimthornBushBag : DruidDamageItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Crimthorn Seed Bag");
			base.Tooltip.SetDefault("[c/91dc16:---Druid Class---]\nThrows a seed that grows into a spikey Crimthorn Bush");
		}
		...
		public override void SafeSetDefaults()
		{
			...
			base.item.shoot = base.mod.ProjectileType("Seed6");
