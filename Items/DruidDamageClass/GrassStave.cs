...
namespace Redemption.Items.DruidDamageClass
{
	public class GrassStave : DruidDamageItem
	{
		public override void SetStaticDefaults()
		{
			...
			base.Tooltip.SetDefault("[c/91dc16:---Druid Class---]\nShoots 2 leaves\nRight-clicking will summon a Mud Guardian [c/94c2ff:(Requires 200 Mana)]\n[c/71ee8d:-Guardian Info-]\n[c/a0db98:Type:] Defensive/Offensive\n[c/98dbc3:Special Ability:] Ring of Thorns/Scatter-Shot\n[c/98c1db:Buffs:] +4 defence, +25 max mana, 50% contact damage will get sent back to the enemy (Ring of Thorns)\nWill only attack if the owner is under 50% health");
		}
