...
namespace Redemption.Items.DruidDamageClass
{
	public class PalmStave : DruidDamageItem
	{
		public override void SetStaticDefaults()
		{
			...
			base.Tooltip.SetDefault("[c/91dc16:---Druid Class---]\nShoots a leaf\nRight-clicking will summon a Sunny Pixie [c/bee7c9:(20 Second Duration)]\n[c/71ee8d:-Guardian Info-]\n[c/a0db98:Type:] Pixie\n[c/98dbc3:Special Ability:] Swift-Swing/Warmth\n[c/98c1db:Effects:] Staves swing a lot faster, Reduces damage from cold sources");
		}
		...
		public override bool CanUseItem(Player player)
		{
			...
			{
				base.item.mana = 1;
				base.item.buffType = base.mod.BuffType("NatureGuardian22Buff");
				...
				base.item.shoot = base.mod.ProjectileType("NatureGuardian22");
