...
{
	public class ShadewoodStave : DruidDamageItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Shadewood Stave");
			base.Tooltip.SetDefault("[c/91dc16:---Druid Class---]\nShoots a leaf\nRight-clicking will summon a Crimson Pixie [c/94c2ff:(Requires 200 Mana)]\n[c/71ee8d:-Guardian Info-]\n[c/a0db98:Type:] Normal\n[c/98dbc3:Special Ability:] Stream-Shot\n[c/98c1db:Buffs:] 10% druidic damage, faster staves & spirits");
		}
		...
		public override bool CanUseItem(Player player)
		{
			...
			{
				base.item.mana = 200;
				base.item.buffType = base.mod.BuffType("NatureGuardian4Buff");
				base.item.buffTime = 36000;
				base.item.shoot = base.mod.ProjectileType("NatureGuardian4");
