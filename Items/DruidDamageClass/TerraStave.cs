...
namespace Redemption.Items.DruidDamageClass
{
	public class TerraStave : DruidDamageItem
	{
		public override void SetStaticDefaults()
		{
			...
			base.Tooltip.SetDefault("[c/91dc16:---Druid Class---]\nRight-clicking will summon a Terra Guardian [c/bee7c9:(20 Second Duration)]\n[c/71ee8d:-Guardian Info-]\n[c/a0db98:Type:] Guardian\n[c/98dbc3:Special Ability:] Swift-Swing/Scatter-Shot/Terra's Embrace\n[c/98c1db:Effects:] Staves swing a lot faster, Staves that shoot a single projectile will instead shoot a cluster, Druidic Enhancement+++");
		}
