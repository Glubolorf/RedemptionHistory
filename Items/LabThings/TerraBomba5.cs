...
namespace Redemption.Items.LabThings
{
	public class TerraBomba5 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			base.item.shoot = ModContent.ProjectileType<TerraBombaPro5>();
		...
		public override void AddRecipes()
		{
			...
			modRecipe.AddIngredient(782, 333);
		...
		{
			Projectile.NewProjectile(new Vector2(player.position.X, player.position.Y + -1300f), new Vector2(speedX, speedY), ModContent.ProjectileType<TerraBombaPro5>(), 500, 5f, player.whoAmI, 0f, 0f);
			return false;
		}
	}
}
