...
namespace Redemption.Items.LabThings
{
	public class TerraBomba5 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			base.item.shoot = base.mod.ProjectileType("TerraBombaPro5");
		...
		{
			Projectile.NewProjectile(new Vector2(player.position.X, player.position.Y + -1300f), new Vector2(speedX, speedY), base.mod.ProjectileType("TerraBombaPro5"), 500, 5f, player.whoAmI, 0f, 0f);
			return false;
		}
	}
}
