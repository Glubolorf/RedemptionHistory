...
namespace Redemption.Items.LabThings
{
	public class ZoneAccessPanel1 : ModItem
	{
		...
		{
			base.DisplayName.SetDefault("(Old) Lab Access Panel - Alpha");
		...
		public override bool UseItem(Player player)
		{
			...
			TexGen texGenerator = BaseWorldGenTex.GetTexGenerator(mod.GetTexture("WorldGeneration/LabAccess1"), colorToTile, null, null, null, null);
