...
namespace Redemption.Items.LabThings
{
	public class ZoneAccessPanel1 : ModItem
	{
		...
		public override bool UseItem(Player player)
		{
			...
			string text = "Mods.Redemption.Lasers1";
			...
			{
				Main.NewText("Alpha sector laser security has been deactivated", cyan, false);
			}
			...
			TexGen texGenerator = BaseWorldGenTex.GetTexGenerator(inst.GetTexture("WorldGeneration/LabAccess1"), dictionary, null, null, null, null);
			Point point;
