...
namespace Redemption.Items.LabThings
{
	public class ZoneAccessPanel2 : ModItem
	{
		...
		{
			base.DisplayName.SetDefault("(Old) Lab Access Panel - Beta");
		...
		public override bool UseItem(Player player)
		{
			...
			TexGen texGenerator = BaseWorldGenTex.GetTexGenerator(mod.GetTexture("WorldGeneration/LabAccess2"), colorToTile, null, null, null, null);
