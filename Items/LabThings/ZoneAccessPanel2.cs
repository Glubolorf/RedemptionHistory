...
{
	public class ZoneAccessPanel2 : ModItem
	{
		public override string Texture
		{
			get
			{
				return "Redemption/Items/LabThings/ZoneAccessPanel2";
			}
		}
		...
		public override bool UseItem(Player player)
		{
			...
			string text = "Mods.Redemption.Lasers2";
			...
			{
				Main.NewText("Beta sector laser security has been deactivated", cyan, false);
			}
			...
			TexGen texGenerator = BaseWorldGenTex.GetTexGenerator(inst.GetTexture("WorldGeneration/LabAccess2"), dictionary, null, null, null, null);
			Point point;
