...
namespace Redemption.Items.LabThings
{
	public class ZoneAccessPanel7 : ModItem
	{
		...
		{
			base.DisplayName.SetDefault("(Old) Lab Access Panel - Master");
		...
		public override bool UseItem(Player player)
		{
			...
			TexGen texGenerator = BaseWorldGenTex.GetTexGenerator(mod.GetTexture("WorldGeneration/LabAccess7"), colorToTile, null, null, null, null);
