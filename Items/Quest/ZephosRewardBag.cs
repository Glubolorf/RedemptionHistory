...
namespace Redemption.Items.Quest
{
	public class ZephosRewardBag : ModItem
	{
		...
		public override void RightClick(Player player)
		{
			...
			if (num == 0)
			{
				player.QuickSpawnItem(base.mod.ItemType("AncientBrassCleaver"), 1);
			}
			if (num == 1)
			{
			...
			if (num == 3)
			{
				player.QuickSpawnItem(base.mod.ItemType("LivingWoodYoyo"), 1);
			}
			if (num == 4)
			{
			...
			if (num == 5)
			{
				player.QuickSpawnItem(base.mod.ItemType("RustedLongspear"), 1);
			}
			if (num == 6)
			{
				player.QuickSpawnItem(base.mod.ItemType("RustedWarriorsCleaver"), 1);
			}
			if (num == 7)
			{
				player.QuickSpawnItem(base.mod.ItemType("RustyNoblesSword"), 1);
			}
			if (num == 8)
			{
