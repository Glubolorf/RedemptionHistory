...
{
	public class ZephosRewardBag : ModItem
	{
		...
		public override void RightClick(Player player)
		{
			...
			if (num == 0)
			{
				player.QuickSpawnItem(ModContent.ItemType<AncientBrassCleaver>(), 1);
			}
			if (num == 1)
			{
			...
			if (num == 3)
			{
				player.QuickSpawnItem(ModContent.ItemType<LivingWoodYoyo>(), 1);
			}
			if (num == 4)
			{
			...
			if (num == 5)
			{
				player.QuickSpawnItem(ModContent.ItemType<RustedLongspear>(), 1);
			}
			if (num == 6)
			{
				player.QuickSpawnItem(ModContent.ItemType<RustedWarriorsCleaver>(), 1);
			}
			if (num == 7)
			{
				player.QuickSpawnItem(ModContent.ItemType<RustyNoblesSword>(), 1);
			}
			if (num == 8)
			{
			...
			if (Main.hardMode)
			{
				...
				if (num4 == 4)
				{
					player.QuickSpawnItem(ModContent.ItemType<InfectedLens>(), 1);
				}
				if (num4 == 5)
				{
