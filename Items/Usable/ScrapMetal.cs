...
namespace Redemption.Items.Usable
{
	public class ScrapMetal : ModItem
	{
		...
		public override void RightClick(Player player)
		{
			...
			{
				player.QuickSpawnItem(ModContent.ItemType<Mk1Plating>(), Main.rand.Next(1, 4));
			}
			if (Main.rand.Next(2) == 0)
			{
			...
			if (NPC.downedMechBoss1 && NPC.downedMechBoss2 && NPC.downedMechBoss3)
			{
				...
				if (Main.rand.Next(2) == 0)
				{
					player.QuickSpawnItem(ModContent.ItemType<Mk2Plating>(), Main.rand.Next(1, 4));
				}
				if (Main.rand.Next(2) == 0)
				{
			...
			if (NPC.downedGolemBoss)
			{
				if (Main.rand.Next(2) == 0)
				{
					player.QuickSpawnItem(ModContent.ItemType<Mk3Plating>(), Main.rand.Next(1, 4));
				}
				if (Main.rand.Next(2) == 0)
				{
			...
			if (NPC.downedMechBossAny)
			{
				...
				player.QuickSpawnItem(1344, Main.rand.Next(4, 19));
				if (Main.rand.Next(2) == 0)
				{
					player.QuickSpawnItem(391, Main.rand.Next(2, 7));
				}
				if (Main.rand.Next(2) == 0)
				{
					player.QuickSpawnItem(1198, Main.rand.Next(2, 7));
				}
			}
			int num = Main.rand.Next(2);
			if (num == 0)
			{
				player.QuickSpawnItem(22, Main.rand.Next(2, 7));
			}
			if (num == 1)
			{
				player.QuickSpawnItem(704, Main.rand.Next(2, 7));
			}
		}
	}
}
