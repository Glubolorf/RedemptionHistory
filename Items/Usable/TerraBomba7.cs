...
namespace Redemption.Items.Usable
{
	public class TerraBomba7 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			base.item.shoot = ModContent.ProjectileType<TerraBombaPro7>();
		...
		{
			Projectile.NewProjectile(new Vector2(player.position.X, player.position.Y + -1300f), new Vector2(speedX, speedY), ModContent.ProjectileType<TerraBombaPro7>(), 500, 5f, player.whoAmI, 0f, 0f);
			return false;
		}
	}
}
