...
namespace Redemption.Items.Usable
{
	public class ZoneAccessPanel1A : ModItem
	{
		public override string Texture
		{
			get
			{
				return "Redemption/Items/Usable/ZoneAccessPanel1";
			}
		}
		...
		public override bool UseItem(Player player)
		{
			...
			TexGen texGenerator = BaseWorldGenTex.GetTexGenerator(inst.GetTexture("WorldGeneration/ALabAccess1"), colorToTile, null, null, null, null, null, null);
