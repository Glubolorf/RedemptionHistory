...
{
	public class ZoneAccessPanel5A : ModItem
	{
		public override string Texture
		{
			get
			{
				return "Redemption/Items/Usable/ZoneAccessPanel5";
			}
		}

		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Lab Access Panel - Omicron");
		...
		public override bool UseItem(Player player)
		{
			...
			TexGen texGenerator = BaseWorldGenTex.GetTexGenerator(inst.GetTexture("WorldGeneration/ALabAccess5"), colorToTile, null, null, null, null, null, null);
