...
{
	public class ZoneAccessPanel7A : ModItem
	{
		public override string Texture
		{
			get
			{
				return "Redemption/Items/Usable/ZoneAccessPanel7";
			}
		}
		...
		public override bool UseItem(Player player)
		{
			...
			RedeWorld.labAccess[6] = true;
			string key = "Mods.Redemption.Lasers7";
			...
			{
				Main.NewText("All laser security systems has been deactivated", messageColor, false);
			}
			...
			TexGen texGenerator = BaseWorldGenTex.GetTexGenerator(inst.GetTexture("WorldGeneration/ALabAccess7"), colorToTile, null, null, null, null, null, null);
