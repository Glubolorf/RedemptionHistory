	...
	public class BleedingSun : ModItem
	{
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int num79 = 0; num79 < num78; num79++)
			{
				...
				int projectile = Projectile.NewProjectile(vector2.X, vector2.Y, speedX2, speedY2, base.mod.ProjectileType("BleedingSunPro1"), num73, num74, i, 0f, (float)Main.rand.Next(10));
