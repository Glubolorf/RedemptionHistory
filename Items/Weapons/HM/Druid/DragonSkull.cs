...
{
	public class DragonSkull : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Soul Dragon Skull");
		...
		{
			base.projectile.localNPCImmunity[target.whoAmI] = 20;
		...
		public override void AI()
		{
			...
			if (base.projectile.localAI[0] == 1f)
			{
				...
				{
					int dustID = Dust.NewDust(new Vector2(base.projectile.Center.X - 1f, base.projectile.Center.Y - 1f), 2, 2, dustType, 0f, 0f, 100, Color.White, 2.6f);
