...
namespace Redemption.Items.Weapons.HM.Druid.Staves
{
	public class PlanterasStave : DruidStave
	{
		...
		public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
		{
			...
			Texture2D texture = base.mod.GetTexture("Items/Weapons/HM/Druid/Staves/PlanterasStave");
			Texture2D texture2 = base.mod.GetTexture("Items/Weapons/HM/Druid/Staves/PlanterasStave2");
			if (player.altFunctionUse != 2)
			{
