	...
	public class Loreholder : ModItem
	{
		...
		public override void OnHitNPC(Player player, NPC target, int damage, float knockback, bool crit)
		{
			if (player.altFunctionUse == 2)
			{
				...
				if (target.type == ModContent.NPCType<DarkSoul>() || target.type == ModContent.NPCType<DarkSoul2>() || target.type == ModContent.NPCType<DarkSoul3>())
				{
				...
				if (target.type == ModContent.NPCType<AncientStoneGolem>())
				{
				...
				{
					Main.NewText("<Loreholder> A portal that came from another world. With it carries something that could alter our own world.", Color.DarkGoldenrod.R, Color.DarkGoldenrod.G, Color.DarkGoldenrod.B, false);
				}
				...
				{
					Main.NewText("<Loreholder> Gross. Why must you hit it using me!? I don't wanna touch that!", Color.DarkGoldenrod.R, Color.DarkGoldenrod.G, Color.DarkGoldenrod.B, false);
				}
				if (target.type == ModContent.NPCType<IrradiatedBehemoth2>())
				{
					Main.NewText("<Loreholder> Gross. Why must you hit it using me!? I don't wanna touch that giant lump of sludge!", Color.DarkGoldenrod.R, Color.DarkGoldenrod.G, Color.DarkGoldenrod.B, false);
				}
				...
				if (target.type == ModContent.NPCType<Keeper>())
				{
				...
				{
					Main.NewText("<Loreholder> Ouch, hey, that worm's armour is tough! It was a warmachine designed by Teochrome, but has since been corrupted.", Color.DarkGoldenrod.R, Color.DarkGoldenrod.G, Color.DarkGoldenrod.B, false);
				}
				if (target.type == ModContent.NPCType<SoI>())
				{
					Main.NewText("<Loreholder> A sentient clump of overworldly infection.", Color.DarkGoldenrod.R, Color.DarkGoldenrod.G, Color.DarkGoldenrod.B, false);
				}
				if (target.type == ModContent.NPCType<KS3_Body>())
				{
				...
				if (target.type == ModContent.NPCType<KS3_Body_Clone>())
				{
				...
				{
					Main.NewText("<Loreholder> The jaw of MACE Project", Color.DarkGoldenrod.R, Color.DarkGoldenrod.G, Color.DarkGoldenrod.B, false);
				}
				...
				{
					Main.NewText("<Loreholder> A bigass skeleton covered in boiling blood and flesh. When killed, they will explode.", Color.DarkGoldenrod.R, Color.DarkGoldenrod.G, Color.DarkGoldenrod.B, false);
				}
				...
				if (target.type == ModContent.NPCType<StarWyvernHead>() || target.type == ModContent.NPCType<StarWyvernBody>())
				{
				...
				if (target.type == ModContent.NPCType<NebP1>() || target.type == ModContent.NPCType<NebP2>())
				{
				...
				{
					Main.NewText("<Loreholder> Protector Bolt... Or was it Volt? He is a high ranking bot who works for Girus, and an ex-Bear unit of the Extermination Squad in Liden.", Color.DarkGoldenrod.R, Color.DarkGoldenrod.G, Color.DarkGoldenrod.B, false);
				}
