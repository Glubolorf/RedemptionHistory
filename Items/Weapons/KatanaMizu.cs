...
{
	public class KatanaMizu : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Mizu Katana");
			base.Tooltip.SetDefault("'Imbued with Water'");
		}
		...
		public override void AddRecipes()
		{
			...
			modRecipe.AddIngredient(169, 25);
			modRecipe.AddIngredient(317, 5);
