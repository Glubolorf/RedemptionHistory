...
{
	public class XeniumDrone11 : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Xenium Autoturret (Party)");
		...
		public override void SetDefaults()
		{
			...
			base.item.shoot = ModContent.ProjectileType<XeniumTurretMinion11>();
			base.item.shootSpeed = 8f;
			base.item.buffType = ModContent.BuffType<XeniumTurretBuff11>();
		...
		public override void AddRecipes()
		{
			...
			modRecipe.AddIngredient(1349, 500);
