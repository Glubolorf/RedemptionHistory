...
{
	public class XeniumDrone3 : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Xenium Autoturret (Cursed)");
		...
		public override void SetDefaults()
		{
			...
			base.item.shoot = ModContent.ProjectileType<XeniumTurretMinion3>();
			base.item.shootSpeed = 8f;
			base.item.buffType = ModContent.BuffType<XeniumTurretBuff3>();
		...
		public override void AddRecipes()
		{
			...
			modRecipe.AddIngredient(546, 500);
