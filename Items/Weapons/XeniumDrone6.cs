...
{
	public class XeniumDrone6 : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Xenium Autoturret (High Velocity)");
		...
		public override void SetDefaults()
		{
			...
			base.item.shoot = ModContent.ProjectileType<XeniumTurretMinion6>();
			base.item.shootSpeed = 8f;
			base.item.buffType = ModContent.BuffType<XeniumTurretBuff6>();
		...
		public override void AddRecipes()
		{
			...
			modRecipe.AddIngredient(1302, 500);
