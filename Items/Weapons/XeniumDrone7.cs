...
{
	public class XeniumDrone7 : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Xenium Autoturret (Ichor)");
		...
		public override void SetDefaults()
		{
			...
			base.item.shoot = ModContent.ProjectileType<XeniumTurretMinion7>();
			base.item.shootSpeed = 8f;
			base.item.buffType = ModContent.BuffType<XeniumTurretBuff7>();
		...
		public override void AddRecipes()
		{
			...
			modRecipe.AddIngredient(1335, 500);
