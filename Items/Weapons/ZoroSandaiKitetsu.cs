...
{
	public class ZoroSandaiKitetsu : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Sandai Kitetsu");
		...
		public override void MeleeEffects(Player player, Rectangle hitbox)
		{
			...
			{
				Dust.NewDust(new Vector2((float)hitbox.X, (float)hitbox.Y), hitbox.Width, hitbox.Height, 240, 0f, 0f, 0, default(Color), 1f);
			}
		}
		...
		public override void AddRecipes()
		{
			...
			modRecipe.AddIngredient(3456, 15);
