	...
	public class BloodBook : ModItem
	{
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				Projectile.NewProjectile(vector.X, vector.Y, num4, num5, base.mod.ProjectileType("BloodBookPro1"), damage, knockBack, Main.myPlayer, 0f, 0f);
				Projectile.NewProjectile(vector.X, vector.Y, num4 * 0.6f, num5 * 0.6f, base.mod.ProjectileType("BloodBookPro1"), damage, knockBack, Main.myPlayer, 0f, 0f);
			}
			return false;
		}
