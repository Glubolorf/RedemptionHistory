...
namespace Redemption.Items.Weapons.v08
{
	public class BloodBook : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			base.item.shoot = ModContent.ProjectileType<BloodBookPro1>();
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int i = 0; i < ShotAmt; i++)
			{
				...
				Projectile.NewProjectile(vector2.X, vector2.Y, vX, vY, ModContent.ProjectileType<BloodBookPro1>(), damage, knockBack, Main.myPlayer, 0f, 0f);
				Projectile.NewProjectile(vector2.X, vector2.Y, vX * 0.6f, vY * 0.6f, ModContent.ProjectileType<BloodBookPro1>(), damage, knockBack, Main.myPlayer, 0f, 0f);
			}
			return false;
		}
