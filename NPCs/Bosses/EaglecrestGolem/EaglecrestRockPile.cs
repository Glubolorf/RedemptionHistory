...
namespace Redemption.NPCs.Bosses.EaglecrestGolem
{
	public class EaglecrestRockPile : ModNPC
	{
		...
		public override void AI()
		{
			...
			BaseAI.AIZombie(base.npc, ref base.npc.ai, false, false, -1, 0.07f, 4f, 40, 20, 60, true, 10, 60, false, null, false);
		}

		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			Texture2D texture2D = Main.npcTexture[base.npc.type];
			Texture2D texture = base.mod.GetTexture("NPCs/Bosses/EaglecrestGolem/EaglecrestRockPileHop");
