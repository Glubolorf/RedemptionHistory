	...
	public class StormSummonerPro : ModProjectile
	{
		...
		public override void AI()
		{
			...
			else if (base.projectile.ai[0] == 3f && base.projectile.localAI[0] == 2f)
			{
				for (int i = -6; i <= 6; i++)
				{
					Projectile.NewProjectile(base.projectile.Center, 10f * Utils.RotatedBy(Vector2.UnitX, 0.5235987755982988 * (double)i, default(Vector2)), ModContent.ProjectileType<StormSummonerPro2>(), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 0f);
				}
			}
		}
