...
{
	public class KSHitboxFistC : KSHitbox
	{
		...
		public override void AI()
		{
			...
			Vector2 HitPos = new Vector2((npc2.spriteDirection == -1) ? (npc2.Center.X - 28f) : (npc2.Center.X + 28f), npc2.Center.Y - 18f);
			base.projectile.Center = HitPos;
			base.projectile.velocity = Vector2.Zero;
			if (npc2.ai[1] != 4f || npc2.ai[0] != 5f)
			{
				base.projectile.Kill();
			}
		}
