...
{
	public class KSMagnetBeam3C : ModProjectile
	{
		public override string Texture
		{
			get
			{
				return "Redemption/NPCs/Bosses/KSIII/KSMagnetBeam3";
			}
		}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Texture2D texture2D20 = base.mod.GetTexture("NPCs/Bosses/KSIII/KSMagnetBeam3_Beam");
			Texture2D texture2D21 = base.mod.GetTexture("NPCs/Bosses/KSIII/KSMagnetBeam3_End");
