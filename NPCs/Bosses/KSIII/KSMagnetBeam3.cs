...
{
	public class KSMagnetBeam3 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (magnet < 0 || magnet >= 200 || !Main.npc[magnet].active || Main.npc[magnet].type != ModContent.NPCType<KS3Magnet>())
			{
			...
			if (base.projectile.ai[1] > 20f)
			{
				player.GetModPlayer<ScreenPlayer>().Rumble(2, 2);
			}
