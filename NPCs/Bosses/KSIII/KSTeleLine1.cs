...
{
	public class KSTeleLine1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (npc.active && npc.type == ModContent.NPCType<KS3_Body>())
			{
				base.projectile.Center = npc.Center + RedeHelper.PolarVector(54f, (npc.modNPC as KS3_Body).gunRot) + RedeHelper.PolarVector((float)(13 * npc.spriteDirection), (npc.modNPC as KS3_Body).gunRot - 1.5707964f);
				base.projectile.velocity = RedeHelper.PolarVector(10f, (npc.modNPC as KS3_Body).gunRot);
			}
			else if (npc.active && npc.type == ModContent.NPCType<KS3_Body_Clone>())
			{
				base.projectile.Center = npc.Center + RedeHelper.PolarVector(54f, (npc.modNPC as KS3_Body_Clone).gunRot) + RedeHelper.PolarVector((float)(13 * npc.spriteDirection), (npc.modNPC as KS3_Body_Clone).gunRot - 1.5707964f);
				base.projectile.velocity = RedeHelper.PolarVector(10f, (npc.modNPC as KS3_Body_Clone).gunRot);
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Color color44 = base.projectile.GetAlpha(Color.White) * 0.8f;
