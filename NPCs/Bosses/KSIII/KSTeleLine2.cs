...
{
	public class KSTeleLine2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			base.projectile.velocity = npc.DirectionTo(Main.player[npc.target].Center + Main.player[npc.target].velocity * 20f);
