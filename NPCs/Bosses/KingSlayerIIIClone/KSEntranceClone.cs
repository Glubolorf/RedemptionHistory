...
namespace Redemption.NPCs.Bosses.KingSlayerIIIClone
{
	...
	public class KSEntranceClone : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (base.npc.ai[1] == 60f && !RedeConfigClient.Instance.NoBossText)
			{
			...
			if (base.npc.ai[1] == 220f && !RedeConfigClient.Instance.NoBossText)
			{
			...
			if (base.npc.ai[2] == 1f)
			{
				...
				if (this.shieldEvent == KSEntranceClone.AISTATE_SHIELD1)
				{
					this.customAI[4] += 1f;
				...
				if (this.shieldEvent == KSEntranceClone.AISTATE_SHIELD2)
				{
					this.customAI[4] += 1f;
					if (this.customAI[4] >= 120f && this.customAI[4] < 520f)
					{
				...
				if (this.shieldEvent == KSEntranceClone.AISTATE_SHIELD3)
				{
					this.customAI[4] += 1f;
					if (this.customAI[4] == 120f)
					{
				...
				if (this.shieldEvent == KSEntranceClone.AISTATE_SHIELD4)
				{
					this.customAI[4] += 1f;
			...
			if (base.npc.life < (int)((float)base.npc.lifeMax * 0.55f) && this.shieldEvent == KSEntranceClone.AISTATE_SHIELD1)
			{
				base.npc.ai[2] = 2f;
				this.customAI[1] += 1f;
				this.chargeAttack = false;
			...
			if (base.npc.life < (int)((float)base.npc.lifeMax * 0.35f) && this.shieldEvent == KSEntranceClone.AISTATE_SHIELD2)
			{
				base.npc.ai[2] = 2f;
				this.customAI[1] += 1f;
				this.chargeAttack = false;
			...
			if (base.npc.life <= 10000 && this.shieldEvent == KSEntranceClone.AISTATE_SHIELD3)
			{
				base.npc.ai[2] = 2f;
				this.customAI[1] += 1f;
				this.chargeAttack = false;
				...
				if (this.customAI[1] >= 580f && !NPC.AnyNPCs(base.mod.NPCType("SpaceKeeper")))
				{
					...
					if (this.customAI[2] == 200f && !RedeConfigClient.Instance.NoBossText)
					{
					...
					if (this.customAI[2] >= 340f)
					{
						...
						this.customAI[1] = 0f;
						this.customAI[2] = 0f;
						this.shieldEvent = KSEntranceClone.AISTATE_SHIELD4;
						this.customAI[4] = 0f;
						base.npc.ai[2] = 1f;
						this.shieldUp = false;
						this.idle2R = true;
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D charge = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSChargeClone");
			Texture2D chargeR = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSChargeRClone");
			Texture2D idlesprite = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSIdle1Clone");
			Texture2D idlesprite2 = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSIdle2Clone");
			Texture2D idlesprite2R = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSIdle2RClone");
			Texture2D fist = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSRocket1Clone");
			Texture2D fist1R = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSRocket1RClone");
			Texture2D fist2 = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSRocket2Clone");
			Texture2D shield = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSShieldClone");
			base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSExitClone");
			Texture2D gunblink = base.mod.GetTexture("NPCs/Bosses/KingSlayerIIIClone/KSGunBlinkClone");
