...
namespace Redemption.NPCs.Bosses.KingSlayerIIIClone
{
	...
	public class KSEntranceClone : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (base.npc.life <= 30000 && this.shieldEvent == KSEntranceClone.AISTATE_SHIELD1)
			{
				base.npc.ai[2] = 2f;
				this.customAI[1] += 1f;
				this.chargeAttack = false;
			...
			if (base.npc.life <= 24000 && this.shieldEvent == KSEntranceClone.AISTATE_SHIELD2)
			{
				base.npc.ai[2] = 2f;
				this.customAI[1] += 1f;
				this.chargeAttack = false;
