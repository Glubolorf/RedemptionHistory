...
namespace Redemption.NPCs.Bosses.Neb
{
	public class CosmicEye : ModProjectile
	{
		...
		public override void AI()
		{
			...
			base.projectile.velocity = -base.projectile.DirectionTo(npc2.Center) * 10f;
			...
			if (base.projectile.localAI[0] == 0f)
			{
				...
				if (base.projectile.alpha <= 0)
				{
					...
					{
						Projectile.NewProjectile(base.projectile.Center, base.projectile.velocity, ModContent.ProjectileType<CosmicEyeBeam>(), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, (float)base.projectile.whoAmI, 0f);
					}
