...
{
	public class CrystalStarTele : ModProjectile
	{
		...
		public override void AI()
		{
			if (this.attackCounter == 0f)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.velocity, ModContent.ProjectileType<CrystalStarPro1>(), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
				}
