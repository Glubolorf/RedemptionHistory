	...
	public class NebP1 : ModNPC
	{
				...
				for (int i = 0; i < 255; i++)
				{
					...
					if (player2.active)
					{
						for (int j = 0; j < player2.inventory.Length; j++)
						{
							...
							{
								Main.NewText("<Chalice of Alignment> Good job.", Color.DarkGoldenrod, false);
							}
						}
		...
		public override void AI()
		{
			...
			if (!this.title)
			{
				...
				{
					Redemption.Inst.TitleCardUIElement.DisplayTitle("Nebuleus", 60, 90, 0.8f, 0, new Color?(Color.HotPink), "Angel of the Cosmos", true);
				}
				this.title = true;
			}
			...
			if (base.npc.life < (int)((float)base.npc.lifeMax * 0.01f) && !RedeConfigClient.Instance.NoLoreElements && this.phase < 4)
			{
				base.npc.ai[0] = 6f;
				base.npc.netUpdate = true;
			}
			...
			case 1:
				base.npc.LookAtPlayer();
				base.npc.ai[2] += 1f;
				if (RedeWorld.nebDeath == 0)
				{
					if (base.npc.ai[2] < 1460f)
					{
					...
					if (!Main.dedServ)
					{
						if (base.npc.ai[2] == 60f)
						{
							...
							{
								Redemption.Inst.DialogueUIElement.DisplayDialogue(player.name + ", I've been observing you from afar,\nI've seen the calamity you've caused,\nthe power you've gained...", 300, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
							}
							else
							{
								Redemption.Inst.DialogueUIElement.DisplayDialogue(player.name + ", I've been observing you from afar,\nyou've been gaining a lot of power...", 300, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
							}
						}
						if (base.npc.ai[2] == 360f)
						{
							Main.PlaySound(12, -1, -1, 1, 1f, 0f);
							Redemption.Inst.DialogueUIElement.DisplayDialogue("I fear I may be too late,\nbut your existence has brought a disequilibrium upon this world...", 300, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
						if (base.npc.ai[2] == 660f)
						{
							Main.PlaySound(12, -1, -1, 1, 1f, 0f);
							Redemption.Inst.DialogueUIElement.DisplayDialogue("If I don't stop you now, you may grow too strong for anyone to handle...", 200, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
						if (base.npc.ai[2] == 860f)
						{
							Main.PlaySound(12, -1, -1, 1, 1f, 0f);
							Redemption.Inst.DialogueUIElement.DisplayDialogue("But enough chatter, I'm sure you're not interested in what I have to say.", 200, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
						if (base.npc.ai[2] == 1060f)
						{
							Main.PlaySound(12, -1, -1, 1, 1f, 0f);
							Redemption.Inst.DialogueUIElement.DisplayDialogue("Just know, " + player.name + ", I am doing this for your sake too...", 200, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
						if (base.npc.ai[2] == 1260f)
						{
							Main.PlaySound(12, -1, -1, 1, 1f, 0f);
							Redemption.Inst.DialogueUIElement.DisplayDialogue("If you lose to me... Maybe the Demigod won't notice you.", 200, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
					}
					if (base.npc.ai[2] == 1460f)
					{
						...
						if (!Main.dedServ)
						{
							Redemption.Inst.DialogueUIElement.DisplayDialogue("Now go, my pet! I will back you up.", 120, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
						base.npc.ai[3] = 1f;
						if (Main.netMode != 1)
						{
					...
					if (base.npc.ai[2] >= 1680f)
					{
						RedeWorld.nebDeath = 1;
						base.npc.ai[3] = 2f;
						base.npc.ai[0] = 2f;
						if (!RedeConfigClient.Instance.NoLoreElements && !Main.dedServ)
						{
				...
				else
				{
					if (base.npc.ai[2] == 30f)
					{
						...
						if (!Main.dedServ)
						{
							Redemption.Inst.DialogueUIElement.DisplayDialogue((RedeWorld.nebDeath < 5) ? "You... are still alive?" : "You still want to fight?", 120, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
						base.npc.ai[3] = 1f;
						if (Main.netMode != 1)
						{
			...
			case 3:
				...
				if (base.npc.ai[2] == 60f)
				{
					...
					if (!Main.dedServ)
					{
						Redemption.Inst.DialogueUIElement.DisplayDialogue("My turn.", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
				}
					...
					if ((this.phase <= 0) ? (base.npc.ai[2] == 30f || base.npc.ai[2] == 70f) : (base.npc.ai[2] == 30f || base.npc.ai[2] == 50f))
					{
						...
						for (int m = 0; m < pieCut3; m++)
						{
							if (Main.netMode != 1)
							{
								...
								Main.projectile[projID3].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(5f, 0f), (float)m / (float)pieCut3 * 6.28f);
					...
					if ((this.phase <= 0) ? (base.npc.ai[2] == 50f) : (base.npc.ai[2] == 40f))
					{
						...
						for (int n = 0; n < pieCut4; n++)
						{
							if (Main.netMode != 1)
							{
								...
								Main.projectile[projID4].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(5f, 0f), (float)n / (float)pieCut4 * 6.28f);
				...
				case 4:
					...
					if (base.npc.ai[2] == 5f || base.npc.ai[2] == 15f)
					{
						...
						for (int m2 = 0; m2 < 4; m2++)
						{
							...
							Main.dust[dustID].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(12f, 0f), (float)m2 / 8f * 6.28f);
					...
					if (base.npc.ai[2] == 10f || ((this.phase >= 1) ? (base.npc.ai[2] == 20f) : (base.npc.ai[2] == -1f)))
					{
						...
						for (int m3 = 0; m3 < 4; m3++)
						{
							...
							Main.dust[dustID2].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(12f, 0f), (float)m3 / 8f * 6.28f);
						...
						if (this.ChainHitBoxArea[i5].Intersects(this.PlayerSafeHitBox))
						{
							if (!ScreenPlayer.NebCutscene && base.npc.ai[2] < 300f)
							{
								...
								for (int m4 = 0; m4 < 8; m4++)
								{
									...
									Main.dust[dustID3].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(12f, 0f), (float)m4 / 8f * 6.28f);
							...
							else
							{
								if (base.npc.ai[2] == 300f)
								{
									for (int m5 = 0; m5 < 8; m5++)
									{
										...
										Main.dust[dustID4].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(12f, 0f), (float)m5 / 8f * 6.28f);
						...
						if (base.npc.ai[2] == 130f || base.npc.ai[2] == 170f)
						{
							...
							for (int m6 = 0; m6 < pieCut5; m6++)
							{
								if (Main.netMode != 1)
								{
									...
									Main.projectile[projID5].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(5f, 0f), (float)m6 / (float)pieCut5 * 6.28f);
						...
						if (base.npc.ai[2] == 150f)
						{
							...
							for (int m7 = 0; m7 < pieCut6; m7++)
							{
								if (Main.netMode != 1)
								{
									...
									Main.projectile[projID6].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(5f, 0f), (float)m7 / (float)pieCut6 * 6.28f);
					...
					if (base.npc.ai[2] == 30f || base.npc.ai[2] == 50f)
					{
						...
						for (int m8 = 0; m8 < pieCut7; m8++)
						{
							if (Main.netMode != 1)
							{
								...
								Main.projectile[projID7].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(5f, 0f), (float)m8 / (float)pieCut7 * 6.28f);
					...
					if (base.npc.ai[2] == 40f)
					{
						...
						for (int m9 = 0; m9 < pieCut8; m9++)
						{
							if (Main.netMode != 1)
							{
								...
								Main.projectile[projID8].velocity = BaseUtility.RotateVector(default(Vector2), new Vector2(5f, 0f), (float)m9 / (float)pieCut8 * 6.28f);
			...
			case 6:
				...
				if (base.npc.life < (int)((float)base.npc.lifeMax * 0.01f) && !RedeConfigClient.Instance.NoLoreElements)
				{
					base.npc.ai[0] = 8f;
					this.phase = 4;
				}
			...
			case 7:
				...
				if (base.npc.ai[2] == 30f)
				{
					...
					if (!Main.dedServ)
					{
						if (this.phase <= 1)
						{
							if (RedeWorld.nebDeath < 2)
							{
								Main.PlaySound(12, -1, -1, 1, 1f, 0f);
								Redemption.Inst.DialogueUIElement.DisplayDialogue("Why do you blindly fight? What is your goal?", 200, 1, 0.6f, "Nebuleus:", 2f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
							}
						}
						else if (this.phase == 2)
						{
							if (RedeWorld.nebDeath < 3)
							{
								Main.PlaySound(12, -1, -1, 1, 1f, 0f);
								Redemption.Inst.DialogueUIElement.DisplayDialogue("Do you even have a motive for your actions?", 200, 1, 0.6f, "Nebuleus:", 2f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
							}
						}
						else if (this.phase == 3 && RedeWorld.nebDeath < 4)
						{
							Main.PlaySound(12, -1, -1, 1, 1f, 0f);
							Redemption.Inst.DialogueUIElement.DisplayDialogue("Still fighting? Well I'm not done yet!", 200, 1, 0.6f, "Nebuleus:", 2f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
					}
					base.npc.netUpdate = true;
				}
				...
				if (base.npc.ai[2] > 250f)
				{
					if (this.phase <= 1 && RedeWorld.nebDeath < 2)
					{
						RedeWorld.nebDeath = 2;
					}
					if (this.phase == 2 && RedeWorld.nebDeath < 3)
					{
						RedeWorld.nebDeath = 3;
					}
					if (this.phase == 3 && RedeWorld.nebDeath < 4)
					{
						RedeWorld.nebDeath = 4;
					}
					base.npc.ai[2] = 0f;
					base.npc.ai[0] = 4f;
					base.npc.netUpdate = true;
			...
			case 8:
				base.npc.LookAtPlayer();
				base.npc.ai[2] += 1f;
				if ((RedeWorld.nebDeath < 5 && base.npc.life < (int)((float)base.npc.lifeMax * 0.01f)) ? (base.npc.ai[2] == 30f) : (base.npc.ai[2] == 2530f))
				{
					Main.PlaySound(SoundID.NPCDeath59, (int)base.npc.position.X, (int)base.npc.position.Y);
					this.RazzleDazzle();
				}
				...
				if (!Main.dedServ)
				{
					...
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("I would appear to be fighting a hopeless battle...", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 280f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("Ever since this island suddenly appeared, I have been watching.", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 460f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("I've seen you be slain countless times,\nHowever you never truly die.", 240, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 700f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("It would seem most who've fought you never realise this.", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 880f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("But I do.", 100, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 980f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("Whether it be intelligence, power, or something else,\nI still remember...", 240, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 1220f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("And those you slain can be brought back...\nAs if the fight never happened.", 240, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 1460f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("...", 80, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 1540f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("... Say, if you killed someone unaffected...", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 1720f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("... Would they die for good?", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 1900f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("Whatever the case may be, I no longer wish to fight you...", 220, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 2120f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue((RedeWorld.redemptionPoints >= 0) ? "I'm sorry for assuming you were bad." : "Not like I could do anything to stop you.", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 2300f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue((RedeWorld.redemptionPoints >= 0) ? "Looking back at it, you've actually defeated many evils." : "I hope you find it in your heart to stop your rampage.", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
				}
				if (RedeWorld.redemptionPoints >= 0)
				{
					if (base.npc.ai[2] == 2480f && RedeWorld.nebDeath < 5 && !Main.dedServ)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("As for myself I will be leaving, but we can always spar again. Goodbye.", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] >= 2660f)
					{
						base.npc.life = 1;
						base.npc.ai[2] = 0f;
						base.npc.ai[0] = 11f;
				...
				{
					if (base.npc.ai[2] == 2480f && !Main.dedServ)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("If you don't attack me now, I'll leave you be.", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] >= 2660f)
					{
			...
			case 10:
				...
				if (!Main.dedServ)
				{
					...
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("You still want to fight?", 150, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 170f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue((RedeWorld.redemptionPoints >= 0) ? "Maybe you are mistaken, I'm not evil..." : "Of course it wouldn't be that easy...", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 350f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue((RedeWorld.redemptionPoints >= 0) ? "Do you just want to spar perhaps... ?" : "You've had your chance at redemption, so don't blame me...", 180, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 530f)
					{
						Main.PlaySound(12, -1, -1, 1, 1f, 0f);
						Redemption.Inst.DialogueUIElement.DisplayDialogue("... When you die a thousand times!", 180, 1, 0.6f, "Nebuleus:", 1.5f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
					}
					if (base.npc.ai[2] == 480f)
					{
						Main.PlaySound(base.mod.GetLegacySoundSlot(50, "Sounds/Custom/Transformation"), (int)base.npc.position.X, (int)base.npc.position.Y);
					}
				}
				if (base.npc.ai[2] == 573f)
				{
					base.npc.Shoot(base.npc.Center, ModContent.ProjectileType<Transition>(), 0, Vector2.Zero, false, SoundID.Item1.WithVolume(0f), "", 0f, 0f);
				}
				if (base.npc.ai[2] == 670f)
				{
					base.npc.Shoot(base.npc.Center, ModContent.ProjectileType<ShockwaveBoom2>(), 0, Vector2.Zero, false, SoundID.Item1.WithVolume(0f), "", 0f, 0f);
				}
				if (base.npc.ai[2] > 700f)
				{
					if (RedeWorld.nebDeath < 5)
					...
					for (int p = 0; p < 255; p++)
					{
						if (Main.player[p].active || Main.player[p].statLife < Main.player[p].statLifeMax2)
						{
							...
							Main.player[p].HealEffect(Main.player[p].statLifeMax2, true);
						}
					}
					base.npc.SetDefaults(ModContent.NPCType<NebP2>(), -1f);
					base.npc.netUpdate = true;
				}
				break;
			case 11:
				...
				if (RedeWorld.redemptionPoints >= 0)
				{
					...
					if (!Main.dedServ)
					{
						Main.PlaySound(base.mod.GetLegacySoundSlot(50, "Sounds/Custom/Teleport1"), (int)base.npc.position.X, (int)base.npc.position.Y);
					}
					if (RedeWorld.nebDeath < 5)
					{
						RedeWorld.nebDeath = 5;
				...
				else
				{
					if (!Main.dedServ)
					{
						...
						{
							Main.PlaySound(12, -1, -1, 1, 1f, 0f);
							Redemption.Inst.DialogueUIElement.DisplayDialogue("...", 120, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
						if (base.npc.ai[2] == 150f)
						{
							Main.PlaySound(12, -1, -1, 1, 1f, 0f);
							Redemption.Inst.DialogueUIElement.DisplayDialogue((RedeWorld.redemptionPoints >= 0) ? "Thank you...\nPlease, continue slaying evil, this world could do with a hero." : "Thank you...\nAt first I thought the concept of not killing was foreign to you.", 200, 1, 0.6f, "Nebuleus:", 1f, new Color?(RedeColor.NebColour), null, null, new Vector2?(base.npc.Center), 0, 0);
						}
					}
			...
			if (Vector2.Distance(base.npc.Center, player.Center) >= 950f && base.npc.ai[0] > 0f && base.npc.ai[1] != 4f && base.npc.ai[1] != 5f && base.npc.ai[1] != 6f && base.npc.ai[1] != 3f && !player.GetModPlayer<ScreenPlayer>().lockScreen)
			{
				this.Teleport(false, Vector2.Zero);
				base.npc.netUpdate = true;
			}
		...
		{
			if (base.npc.ai[0] == 11f || RedeConfigClient.Instance.NoLoreElements)
			{
				return true;
			}
			if (base.npc.ai[0] == 9f)
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			if (base.npc.ai[3] != 6f)
			{
				...
				if (base.npc.ai[3] == 8f)
				{
					...
					Main.spriteBatch.Draw(armsEyesAni, drawCenter - Main.screenPosition, new Rectangle?(new Rectangle(0, y11, armsEyesAni.Width, num219)), drawColor * ((float)(255 - base.npc.alpha) / 255f), base.npc.rotation, new Vector2((float)armsEyesAni.Width / 2f, (float)num219 / 2f), base.npc.scale, (base.npc.spriteDirection == -1) ? SpriteEffects.None : SpriteEffects.FlipHorizontally, 0f);
