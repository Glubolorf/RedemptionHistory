...
namespace Redemption.NPCs.Bosses.Neb
{
	public class NebTeleLine1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				base.projectile.alpha = (int)MathHelper.Lerp(255f, 100f, base.projectile.localAI[0] / 30f);
			}
			if (base.projectile.localAI[0] >= base.projectile.ai[0])
			{
				float timer = base.projectile.localAI[0] - 60f;
				base.projectile.alpha = (int)MathHelper.Lerp(100f, 255f, timer / 30f);
			}
			base.projectile.Center = npc.Center;
			if (base.projectile.localAI[0] < base.projectile.ai[0] - 40f)
			{
