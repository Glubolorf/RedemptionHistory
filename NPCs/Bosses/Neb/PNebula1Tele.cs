...
{
	public class PNebula1Tele : ModProjectile
	{
		...
		public override void AI()
		{
			if (this.attackCounter == 0f)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.velocity, ModContent.ProjectileType<PNebula1>(), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
					Projectile.NewProjectile(base.projectile.Center, base.projectile.velocity, ModContent.ProjectileType<PNebula2>(), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
					Projectile.NewProjectile(base.projectile.Center, base.projectile.velocity, ModContent.ProjectileType<PNebula3>(), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
				}
