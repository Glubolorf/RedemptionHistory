...
{
	public class StarfallTele : ModProjectile
	{
		...
		public override void AI()
		{
			if (this.attackCounter == 0f)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.velocity, ModContent.ProjectileType<StarFallPro>(), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
				}
