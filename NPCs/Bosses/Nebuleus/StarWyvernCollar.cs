...
{
	public class StarWyvernCollar : StarWyvernHead
	{
		public override string Texture
		{
			get
			{
				return "Redemption/NPCs/Bosses/Nebuleus/StarWyvernCollar";
			}
		}
		...
		public override bool PreAI()
		{
			...
			if (Main.netMode != 1 && (!Main.npc[(int)base.npc.ai[1]].active || Main.npc[(int)base.npc.ai[3]].type != base.mod.NPCType("StarWyvernHead")))
			{
				base.npc.life = 0;
