...
{
	public class OONormalBeamS : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Vector2 GunPos = new Vector2((npc2.spriteDirection != 1) ? (npc2.Center.X - 44f) : (npc2.Center.X + 44f), npc2.Center.Y - 15f);
			base.projectile.Center = GunPos;
			...
			if (base.projectile.ai[1] >= 110f && this.multiplier == 1)
			{
				this.multiplier = -1;
			}
