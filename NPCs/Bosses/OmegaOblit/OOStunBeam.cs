...
{
	public class OOStunBeam : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Stun Ray");
		}
		...
		public override void AI()
		{
			...
			if (base.projectile.ai[1] >= 330f && this.multiplier == 1)
			{
				this.multiplier = -1;
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Texture2D texture2D20 = base.mod.GetTexture("NPCs/Bosses/OmegaOblit/OOStunBeam_Beam");
			Texture2D texture2D21 = base.mod.GetTexture("NPCs/Bosses/OmegaOblit/OOStunBeam_End");
