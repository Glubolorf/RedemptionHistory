...
namespace Redemption.NPCs.Bosses.Thorn
{
	public class CursedThornPro3 : ModProjectile
	{
		...
		{
			Color newLightColor = new Color(Math.Max(0, (int)CursedThornPro3.lightColor.R + Math.Min(0, -base.projectile.alpha + 20)), Math.Max(0, (int)CursedThornPro3.lightColor.G + Math.Min(0, -base.projectile.alpha + 20)), Math.Max(0, (int)CursedThornPro3.lightColor.B + Math.Min(0, -base.projectile.alpha + 20)));
			...
			if (CursedThornPro3.mainTex == null)
			{
				...
				CursedThornPro3.endTex = ModContent.GetTexture("Redemption/NPCs/Bosses/Thorn/CursedThornPro4");
			}
