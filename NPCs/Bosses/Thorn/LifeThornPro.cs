...
{
	public class LifeThornPro : ModProjectile
	{
		...
		{
			if (Main.npc[(int)base.projectile.ai[0]].life < Main.npc[(int)base.projectile.ai[0]].lifeMax - 10)
			{
				Main.npc[(int)base.projectile.ai[0]].life += 10;
				Main.npc[(int)base.projectile.ai[0]].HealEffect(10, true);
			}
		}
	}
}
