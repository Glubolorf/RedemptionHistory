...
namespace Redemption.NPCs.Bosses.Thorn
{
	public class Moonbeam : ModProjectile
	{
		...
		{
			base.DisplayName.SetDefault("Moonbeam");
		}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Texture2D texture2D20 = base.mod.GetTexture("NPCs/Bosses/Thorn/Moonbeam_Beam");
			Texture2D texture2D21 = base.mod.GetTexture("NPCs/Bosses/Thorn/Moonbeam_End");
