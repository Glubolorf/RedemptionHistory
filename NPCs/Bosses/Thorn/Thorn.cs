		...
		public override void AI()
		{
			...
			if (this.customAI[2] == 1f)
			{
				...
				if (base.npc.life < (int)((float)base.npc.lifeMax * 0.5f))
				{
					...
					{
						int p = Projectile.NewProjectile(player.Center.X + 500f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p2 = Projectile.NewProjectile(player.Center.X + -500f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p].netUpdate = true;
						Main.projectile[p2].netUpdate = true;
					}
					if (this.customAI[0] == 80f)
					{
						int p3 = Projectile.NewProjectile(player.Center.X + 400f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p4 = Projectile.NewProjectile(player.Center.X + -400f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p3].netUpdate = true;
						Main.projectile[p4].netUpdate = true;
					}
					if (this.customAI[0] == 100f)
					{
						int p5 = Projectile.NewProjectile(player.Center.X + 300f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p6 = Projectile.NewProjectile(player.Center.X + -300f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p5].netUpdate = true;
						Main.projectile[p6].netUpdate = true;
					}
					if (this.customAI[0] == 120f)
					{
						int p7 = Projectile.NewProjectile(player.Center.X + 200f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p8 = Projectile.NewProjectile(player.Center.X + -200f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p7].netUpdate = true;
						Main.projectile[p8].netUpdate = true;
					}
					if (this.customAI[0] == 140f)
					{
						int p9 = Projectile.NewProjectile(player.Center.X + 100f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p10 = Projectile.NewProjectile(player.Center.X + -100f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p9].netUpdate = true;
						Main.projectile[p10].netUpdate = true;
					}
					if (this.customAI[0] == 160f)
					{
						int p11 = Projectile.NewProjectile(player.Center.X + 0f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
				...
				else
				{
					if (this.customAI[0] == 60f)
					{
						int p12 = Projectile.NewProjectile(player.Center.X + 500f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p13 = Projectile.NewProjectile(player.Center.X + -500f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p12].netUpdate = true;
						Main.projectile[p13].netUpdate = true;
					}
					if (this.customAI[0] == 90f)
					{
						int p14 = Projectile.NewProjectile(player.Center.X + 400f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p15 = Projectile.NewProjectile(player.Center.X + -400f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p14].netUpdate = true;
						Main.projectile[p15].netUpdate = true;
					}
					if (this.customAI[0] == 120f)
					{
						int p16 = Projectile.NewProjectile(player.Center.X + 300f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p17 = Projectile.NewProjectile(player.Center.X + -300f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p16].netUpdate = true;
						Main.projectile[p17].netUpdate = true;
					}
					if (this.customAI[0] == 150f)
					{
						int p18 = Projectile.NewProjectile(player.Center.X + 200f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p19 = Projectile.NewProjectile(player.Center.X + -200f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p18].netUpdate = true;
						Main.projectile[p19].netUpdate = true;
					}
					if (this.customAI[0] == 180f)
					{
						int p20 = Projectile.NewProjectile(player.Center.X + 100f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						int p21 = Projectile.NewProjectile(player.Center.X + -100f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
						Main.projectile[p20].netUpdate = true;
						Main.projectile[p21].netUpdate = true;
					}
					if (this.customAI[0] == 210f)
					{
						int p22 = Projectile.NewProjectile(player.Center.X + 0f, player.Center.Y - 200f, 0f, 0f, base.mod.ProjectileType("ThornSeed"), 10, 1f, Main.myPlayer, 0f, 0f);
			...
			else if (this.customAI[2] == 2f)
			{
				...
				if (base.npc.life < (int)((float)base.npc.lifeMax * 0.5f))
				{
					if (this.customAI[0] == 60f || this.customAI[0] == 90f || this.customAI[0] == 120f || this.customAI[0] == 150f || this.customAI[0] == 180f)
					{
						...
						int damage = 12;
						int type = base.mod.ProjectileType("CursedThornPro3");
				...
				else if (this.customAI[0] == 60f || this.customAI[0] == 90f || this.customAI[0] == 120f)
				{
					...
					int damage2 = 10;
					int type2 = base.mod.ProjectileType("CursedThornPro3");
			...
			else if (this.customAI[2] == 5f)
			{
				...
				if (base.npc.life < (int)((float)base.npc.lifeMax * 0.5f))
				{
					if (this.customAI[0] == 60f || this.customAI[0] == 90f || this.customAI[0] == 120f || this.customAI[0] == 150f || this.customAI[0] == 180f)
					{
						int ProjID = Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, 0f, base.mod.ProjectileType("SlashFlashPro"), 10, 3f, 255, 0f, 0f);
						Main.projectile[ProjID].netUpdate = true;
					}
				...
				else
				{
					...
					{
						int p23 = Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, 0f, base.mod.ProjectileType("SlashFlashPro"), 10, 3f, 255, 0f, 0f);
