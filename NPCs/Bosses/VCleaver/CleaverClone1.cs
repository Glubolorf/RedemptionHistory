...
{
	public class CleaverClone1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!0f.Equals(obj))
			{
				...
				{
					base.projectile.velocity = base.projectile.DirectionTo(player.Center) * 30f;
			...
			{
				base.projectile.rotation = Utils.ToRotation(base.projectile.DirectionTo(player.Center)) + 1.57f;
