...
{
	public class CleaverClone1F : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!0f.Equals(obj))
			{
				...
				ref this.rot.SlowRotation((float)Math.Atan2((double)base.projectile.velocity.Y, (double)base.projectile.velocity.X) + 1.57f, 0.10471976f);
				if (base.projectile.localAI[1] == 0f)
				{
					base.projectile.velocity = base.projectile.DirectionTo(Main.MouseWorld) * 30f;
			...
			{
				base.projectile.rotation = Utils.ToRotation(base.projectile.DirectionTo(Main.MouseWorld)) + 1.57f;
				this.rot = base.projectile.rotation;
