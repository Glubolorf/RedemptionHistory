...
namespace Redemption.NPCs.Bosses.VCleaver
{
	public class RedPrism : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Vector2 BeamPos = new Vector2(npc2.Center.X, npc2.Center.Y) + RedeHelper.PolarVector(134f, npc2.rotation + -1.5707964f);
			base.projectile.Center = BeamPos;
			base.projectile.velocity = RedeHelper.PolarVector(10f, npc2.rotation + -1.5707964f);
			if (npc2.ai[1] == 0f)
			{
				base.projectile.Kill();
			}
			...
			if (base.projectile.ai[1] >= 430f && this.multiplier == 1)
			{
				this.multiplier = -1;
			}
