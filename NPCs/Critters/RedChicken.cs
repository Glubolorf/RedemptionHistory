...
namespace Redemption.NPCs.Critters
{
	public class RedChicken : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			base.npc.catchItem = (short)ModContent.ItemType<ChickenRedItem>();
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Friendly/ChickenGore8"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Friendly/ChickenGore9"), 1f);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D peckAni = base.mod.GetTexture("NPCs/Critters/RedChickenPeck");
