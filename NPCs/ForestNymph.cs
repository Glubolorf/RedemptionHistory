	...
	public class ForestNymph : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (base.npc.velocity.Y == 0f)
			{
				...
				if (num <= 160f && !Main.LocalPlayer.GetModPlayer<RedePlayer>(base.mod).forestFriendly && Main.rand.Next(150) == 0 && !this.slashAttack)
				{
				...
				if (this.slashAttack)
				{
					...
					if (this.slashTimer == 15)
					{
						if (base.npc.direction == -1)
						{
							...
							int num3 = 9;
							int num4 = base.mod.ProjectileType("ForestSicklePro");
						...
						else
						{
							...
							int num8 = 9;
							int num9 = base.mod.ProjectileType("ForestSicklePro");
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D texture = base.mod.GetTexture("NPCs/ForestNymphHop");
			Texture2D texture2 = base.mod.GetTexture("NPCs/ForestNymphSlash");
