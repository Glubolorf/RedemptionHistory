...
namespace Redemption.NPCs.Friendly
{
	...
	public class Fallen : ModNPC
	{
		public override string Texture
		{
			get
			{
				return "Redemption/NPCs/Friendly/Fallen";
			}
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/TownNPC/FallenGore1"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/TownNPC/FallenGore2"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/TownNPC/FallenGore3"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/TownNPC/FallenGore4"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/TownNPC/FallenGore5"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/TownNPC/FallenGore6"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/TownNPC/FallenGore7"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/TownNPC/FallenGore8"), 1f);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D TenvonAni = base.mod.GetTexture("NPCs/Friendly/Fallen2");
			Texture2D HappinsAni = base.mod.GetTexture("NPCs/Friendly/Fallen3");
		...
		public override void SetupShop(Chest shop, ref int nextSlot)
		{
			...
			{
				shop.item[nextSlot].SetDefaults(ModContent.ItemType<Shadesoul>(), false);
