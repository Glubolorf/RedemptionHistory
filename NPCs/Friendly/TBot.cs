...
namespace Redemption.NPCs.Friendly
{
	...
	public class TBot : ModNPC
	{
		...
		{
			return RedeWorld.downedSoI && !NPC.AnyNPCs(ModContent.NPCType<TBotUnconscious>());
		}
		...
		public override string GetChat()
		{
			...
			if (BasePlayer.HasItem(player, ModContent.ItemType<WarheadItem>(), 1, false, false))
			{
				chat.Add("Is that a nuclear warhead in your pocket or are you hap- ...Why do you have a warhead with you?", 1.0);
			}
		...
		public override void SetupShop(Chest shop, ref int nextSlot)
		{
			...
			if (Main.hardMode)
			{
				shop.item[nextSlot].SetDefaults(ModContent.ItemType<WarheadItem>(), false);
				nextSlot++;
			}
