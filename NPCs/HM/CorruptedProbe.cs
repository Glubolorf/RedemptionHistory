...
namespace Redemption.NPCs.HM
{
	public class CorruptedProbe : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/CorruptedProbeGore1"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/CorruptedProbeGore2"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/CorruptedProbeGore3"), 1f);
			}
		}
		...
		public override void AI()
		{
			...
			else
			{
				...
				if (base.npc.ai[1] >= 75f)
				{
					...
					int damage = 30;
					int type = ModContent.ProjectileType<VlitchLaserPro>();
				...
				if (base.npc.life <= 500 && base.npc.ai[1] >= 60f)
				{
					...
					int damage2 = 30;
					int type2 = ModContent.ProjectileType<VlitchLaserPro>();
					Main.PlaySound(2, (int)base.npc.position.X, (int)base.npc.position.Y, 12, 1f, 0f);
				...
				if (base.npc.life <= 200 && base.npc.ai[1] >= 50f)
				{
					...
					int damage3 = 30;
					int type3 = ModContent.ProjectileType<VlitchLaserPro>();
					Main.PlaySound(2, (int)base.npc.position.X, (int)base.npc.position.Y, 12, 1f, 0f);
				...
				if (base.npc.life <= 90 && base.npc.ai[1] >= 25f)
				{
					...
					int damage4 = 30;
					int type4 = ModContent.ProjectileType<VlitchLaserPro>();
					Main.PlaySound(2, (int)base.npc.position.X, (int)base.npc.position.Y, 12, 1f, 0f);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D glowMask = base.mod.GetTexture("NPCs/HM/CorruptedProbe_Glow");
