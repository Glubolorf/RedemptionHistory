...
{
	public class CorruptedWormBody : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/CorruptedWormBodyGore"), 1f);
			}
		}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D glowMask = base.mod.GetTexture("NPCs/HM/CorruptedWormBody_Glow");
