...
namespace Redemption.NPCs.HM
{
	public class CorruptedWormHead : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/CorruptedWormHeadGore"), 1f);
			}
		}
		...
		public override bool PreAI()
		{
			if (Main.netMode != 1 && base.npc.ai[0] == 0f)
			{
				...
				int randomWormLength = Main.rand.Next(2, 4);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D glowMask = base.mod.GetTexture("NPCs/HM/CorruptedWormHead_Glow");
