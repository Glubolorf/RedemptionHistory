...
namespace Redemption.NPCs.HM
{
	public class HallowNymph : ModNPC
	{
				...
				if (this.slashAttack)
				{
					...
					if (this.slashTimer == 10 || this.slashTimer == 15 || this.slashTimer == 20)
					{
						if (base.npc.direction == -1)
						{
							...
							int damage = 23;
							int type = ModContent.ProjectileType<CrystalScythe>();
						...
						else
						{
							...
							int damage2 = 23;
							int type2 = ModContent.ProjectileType<CrystalScythe>();
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/HM/HallowNymphHop");
			Texture2D slashAni = base.mod.GetTexture("NPCs/HM/HallowNymphMAGIC");
