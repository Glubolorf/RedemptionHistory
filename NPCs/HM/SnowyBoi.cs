...
namespace Redemption.NPCs.HM
{
	public class SnowyBoi : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SnowyBoiGore1"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SnowyBoiGore2"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SnowyBoiGore3"), 1f);
		...
		public override void AI()
		{
			...
			if (this.timer == 120)
			{
				...
				int damage = 35;
				int type = ModContent.ProjectileType<SnowyBall2>();
			...
			if (this.timer == 130)
			{
				...
				int damage2 = 35;
				int type2 = ModContent.ProjectileType<SnowyBall2>();
				Main.PlaySound(2, (int)base.npc.position.X, (int)base.npc.position.Y, 12, 1f, 0f);
			...
			if (this.timer == 140)
			{
				...
				int damage3 = 35;
				int type3 = ModContent.ProjectileType<SnowyBall2>();
				Main.PlaySound(2, (int)base.npc.position.X, (int)base.npc.position.Y, 12, 1f, 0f);
			...
			if (this.timer == 150)
			{
				...
				int damage4 = 35;
				int type4 = ModContent.ProjectileType<SnowyBall2>();
				Main.PlaySound(2, (int)base.npc.position.X, (int)base.npc.position.Y, 12, 1f, 0f);
