...
namespace Redemption.NPCs.Lab
{
	public class JanitorBot : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/Lab/JanitorBotHop");
			Texture2D YeetAni = base.mod.GetTexture("NPCs/Lab/JanitorBotYeet");
			Texture2D BucketAni = base.mod.GetTexture("NPCs/Lab/JanitorBotBucketYeet");
			Texture2D HitMopAni = base.mod.GetTexture("NPCs/Lab/JanitorBotHitMop");
			Texture2D SlipAni = base.mod.GetTexture("NPCs/Lab/JanitorBotSlip");
