using System;
using Redemption.Items.Armor.Misc;
...
namespace Redemption.NPCs.Lab
{
	public class JanitorBotNPC : ModNPC
	{
		public override string Texture
		{
			get
			{
				return "Redemption/NPCs/Lab/JanitorBotCleaning";
			}
		}
		...
		public override void SetupShop(Chest shop, ref int nextSlot)
		{
			...
			nextSlot++;
			shop.item[nextSlot].SetDefaults(ModContent.ItemType<LabPlatform>(), false);
			nextSlot++;
			shop.item[nextSlot].SetDefaults(ModContent.ItemType<LabRail_L>(), false);
			nextSlot++;
			shop.item[nextSlot].SetDefaults(ModContent.ItemType<LabRail_Mid>(), false);
			nextSlot++;
			shop.item[nextSlot].SetDefaults(ModContent.ItemType<LabRail_R>(), false);
			nextSlot++;
			...
			nextSlot++;
			shop.item[nextSlot].SetDefaults(ModContent.ItemType<LabToilet>(), false);
			nextSlot++;
