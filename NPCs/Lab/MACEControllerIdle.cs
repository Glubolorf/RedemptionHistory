...
namespace Redemption.NPCs.Lab
{
	public class MACEControllerIdle : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (base.npc.ai[0] == 0f)
			{
				...
				if (base.npc.frameCounter >= 6.0)
				{
					...
					{
						if (!player.IsFullTBot() && NPC.AnyNPCs(ModContent.NPCType<MACEProjectHeadA>()))
						{
							base.npc.ai[0] += 1f;
							base.npc.ai[3] = 0f;
						}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D startAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorStartle");
			Texture2D idleAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorClickButtons");
			Texture2D smashButtonsAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorSmashButtons");
			Texture2D smashLeftAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorSmashButtonsLeft");
			Texture2D smashRightAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorSmashButtonsRight");
			Texture2D kickAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorStepOnButtons");
			Texture2D headbuttAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorHeadbutt");
			Texture2D defeatAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorMACEDefeat");
			Texture2D backAwayAni = base.mod.GetTexture("NPCs/Lab/CraneOperatorBackaway");
