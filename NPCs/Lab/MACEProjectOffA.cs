	...
	public class MACEProjectOffA : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (RedeWorld.maceUS)
			{
				if (!Main.dedServ)
				{
					Redemption.Inst.TitleCardUIElement.DisplayTitle("MACE Project", 60, 90, 0.8f, 0, new Color?(Color.Yellow), "Incomplete War Machine", true);
				}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D trolleyAni = base.mod.GetTexture("NPCs/Lab/CraneTrolley2");
			Texture2D hookAni = base.mod.GetTexture("NPCs/Lab/CraneHook");
			...
			spriteBatch.Draw(texture, base.npc.Center - Main.screenPosition, new Rectangle?(base.npc.frame), drawColor, base.npc.rotation, Utils.Size(base.npc.frame) / 2f, base.npc.scale, (base.npc.spriteDirection == -1) ? SpriteEffects.None : SpriteEffects.FlipHorizontally, 1f);
			return false;
		}
