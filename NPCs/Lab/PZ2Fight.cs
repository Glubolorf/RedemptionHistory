...
namespace Redemption.NPCs.Lab
{
	...
	public class PZ2Fight : ModNPC
	{
		public override string Texture
		{
			get
			{
				return "Redemption/NPCs/Lab/PZ2Eyelid";
			}
		}
		...
		public override void AI()
		{
			...
			if (base.npc.ai[0] == 0f)
			{
				...
				if (base.npc.ai[1] >= 516f)
				{
					Redemption.Inst.TitleCardUIElement.DisplayTitle("Kari Johansson", 60, 90, 0.8f, 0, new Color?(Color.Green), "Patient Zero", true);
					base.npc.ai[0] += 1f;
					base.npc.ai[1] = 0f;
					this.eyeOpen = true;
					base.npc.netUpdate = true;
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D eyeAni = base.mod.GetTexture("NPCs/Lab/PZ2Pupil");
			Texture2D eyeGlow = base.mod.GetTexture("NPCs/Lab/PZ2Pupil_Glow");
			Texture2D bodyAni = base.mod.GetTexture("NPCs/Lab/PZ2");
			Texture2D bodyGlow = base.mod.GetTexture("NPCs/Lab/PZ2_Glow");
			Texture2D coverAni = base.mod.GetTexture("NPCs/Lab/PZ2BodyCover2");
			Texture2D sludgeAni = base.mod.GetTexture("NPCs/Lab/SlimeThings");
