...
namespace Redemption.NPCs.Lab
{
	public class TbotMinibossStart : ModNPC
	{
		public override string Texture
		{
			get
			{
				return "Redemption/NPCs/Lab/TbotMiniboss";
			}
		}
				...
				if (base.npc.ai[0] == 1f)
				{
					if (RedeWorld.voltBegin)
					{
						...
						if (base.npc.ai[1] >= 60f)
						{
							if (!Main.dedServ)
							{
								Redemption.Inst.TitleCardUIElement.DisplayTitle("Protector Volt", 60, 90, 0.8f, 0, new Color?(Color.Yellow), "Omega Division Commander", true);
							}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/Lab/TbotMinibossHop");
			Texture2D gunAni = base.mod.GetTexture("NPCs/Lab/TbotMinibossGun");
