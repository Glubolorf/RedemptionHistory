...
namespace Redemption.NPCs.LabNPCs.New
{
	public class TearOfInfectionBall : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(new Vector2(base.projectile.Center.X, base.projectile.Center.Y), new Vector2(-base.projectile.velocity.X + (float)Main.rand.Next(-2, 2), -base.projectile.velocity.Y + (float)Main.rand.Next(-2, 2)), base.mod.ProjectileType("TearOfInfection"), base.projectile.damage / 2, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			Projectile.NewProjectile(new Vector2(base.projectile.Center.X, base.projectile.Center.Y), new Vector2(-base.projectile.velocity.X + (float)Main.rand.Next(-2, 2), -base.projectile.velocity.Y + (float)Main.rand.Next(-2, 2)), base.mod.ProjectileType("TearOfInfection"), base.projectile.damage / 2, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
