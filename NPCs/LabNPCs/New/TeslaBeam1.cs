...
{
	public class TeslaBeam1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.ai[1] >= 120f && this.multiplier == 1)
			{
				this.multiplier = -1;
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Texture2D texture2D20 = base.mod.GetTexture("NPCs/LabNPCs/New/TeslaBeam1_Beam");
			Texture2D texture2D21 = base.mod.GetTexture("NPCs/LabNPCs/New/TeslaBeam1_End");
