...
namespace Redemption.NPCs.PostML
{
	public class CorruptedCopter1 : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			...
			{
				Projectile.NewProjectile(base.npc.Center.X, base.npc.Center.Y, 0f, 0f, ModContent.ProjectileType<AttackHovercopterPro>(), 50, 3f, 255, (float)((base.npc.spriteDirection == -1) ? 1 : 0), 0f);
				NPC.NewNPC((int)base.npc.Center.X, (int)base.npc.Center.Y, ModContent.NPCType<OmegaPilotDroid>(), 0, 0f, 0f, 0f, 0f, 255);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/AttackHovercopterGore6"), 1f);
				for (int i = 0; i < 25; i++)
				{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D glowMask = base.mod.GetTexture("NPCs/PostML/CorruptedCopter1_Glow");
