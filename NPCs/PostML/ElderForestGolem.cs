...
namespace Redemption.NPCs.PostML
{
	public class ElderForestGolem : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/PostML/ElderForestGolemHop");
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			if (Main.raining)
			{
				return SpawnCondition.Overworld.Chance * ((Main.tile[spawnInfo.spawnTileX, spawnInfo.spawnTileY].type == 2 && RedeWorld.downedPatientZero) ? 0.18f : 0f);
			}
			return SpawnCondition.Overworld.Chance * ((Main.tile[spawnInfo.spawnTileX, spawnInfo.spawnTileY].type == 2 && RedeWorld.downedPatientZero) ? 0.14f : 0f);
		}
