...
namespace Redemption.NPCs.PostML
{
	public class ElderForestGolemWounded : ModNPC
	{
		...
		{
			Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, ModContent.ItemType<LivingTwig>(), Main.rand.Next(24, 36), false, 0, false, false);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/PostML/ElderForestGolemWoundedHop");
