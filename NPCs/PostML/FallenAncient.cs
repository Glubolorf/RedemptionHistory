...
namespace Redemption.NPCs.PostML
{
	public class FallenAncient : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/PostML/FallenAncientHop");
			Texture2D slashAni = base.mod.GetTexture("NPCs/PostML/FallenAncientSlash");
			Texture2D shieldAni = base.mod.GetTexture("NPCs/PostML/FallenAncientShield1");
