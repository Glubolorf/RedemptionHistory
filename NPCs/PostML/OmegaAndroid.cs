...
namespace Redemption.NPCs.PostML
{
	public class OmegaAndroid : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/OAndroidGore3"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/OAndroidGore2"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/OAndroidGore1"), 1f);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D glowMask = base.mod.GetTexture("NPCs/PostML/OmegaAndroid_Glow");
			Texture2D fistAni = base.mod.GetTexture("NPCs/PostML/OmegaAndroidFistRocket");
			Texture2D fistGlow = base.mod.GetTexture("NPCs/PostML/OmegaAndroidFistRocket_Glow");
