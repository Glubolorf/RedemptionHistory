...
namespace Redemption.NPCs.PreHM
{
	public class Blobble : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D flatAni = base.mod.GetTexture("NPCs/PreHM/BlobbleFlat");
			Texture2D hat1Ani = base.mod.GetTexture("NPCs/PreHM/BlobbleHat");
			Texture2D hat2Ani = base.mod.GetTexture("NPCs/PreHM/BlobbleHat2");
			Texture2D hat3Ani = base.mod.GetTexture("NPCs/PreHM/BlobbleHat3");
			Texture2D hat4Ani = base.mod.GetTexture("NPCs/PreHM/BlobbleHat4");
			Texture2D hat5Ani = base.mod.GetTexture("NPCs/PreHM/BlobbleHat5");
		...
		{
			if (Utils.NextBool(Main.rand, 2) && !RedeWorld.blobbleSwarm && RedeWorld.blobbleSwarmCooldown <= 0)
			{
				Main.NewText("A blobble swarm approaches!", Color.PaleGreen, false);
