...
namespace Redemption.NPCs.PreHM
{
	public class BloodWormHead : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			base.npc.value = (float)Item.buyPrice(0, 0, 1, 25);
			base.npc.npcSlots = 1f;
			base.npc.netAlways = true;
			this.banner = base.npc.type;
			this.bannerItem = ModContent.ItemType<BloodWormBanner>();
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/BloodWormGore1"), 1f);
			}
		}
		...
		public override bool PreAI()
		{
			...
			if (Main.netMode != 1 && base.npc.ai[0] == 0f)
			{
				...
				{
					latestNPC = NPC.NewNPC((int)base.npc.Center.X, (int)base.npc.Center.Y, ModContent.NPCType<BloodWormBody>(), base.npc.whoAmI, 0f, (float)latestNPC, 0f, 0f, 255);
					Main.npc[latestNPC].realLife = base.npc.whoAmI;
					Main.npc[latestNPC].ai[3] = (float)base.npc.whoAmI;
				}
				latestNPC = NPC.NewNPC((int)base.npc.Center.X, (int)base.npc.Center.Y, ModContent.NPCType<BloodWormTail>(), base.npc.whoAmI, 0f, (float)latestNPC, 0f, 0f, 255);
				Main.npc[latestNPC].realLife = base.npc.whoAmI;
				Main.npc[latestNPC].ai[3] = (float)base.npc.whoAmI;
				base.npc.ai[0] = 1f;
		...
		{
			return SpawnCondition.Crimson.Chance * ((!Main.hardMode) ? 0.015f : 0f);
		}
	}
}
