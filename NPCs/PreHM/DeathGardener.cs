...
namespace Redemption.NPCs.PreHM
{
	public class DeathGardener : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			this.bannerItem = ModContent.ItemType<DeathGardenerBanner>();
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/DeathGardGore1"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/DeathGardGore2"), 1f);
