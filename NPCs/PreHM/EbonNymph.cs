...
namespace Redemption.NPCs.PreHM
{
	public class EbonNymph : ModNPC
	{
				...
				if (this.slashAttack)
				{
					...
					if (this.slashTimer == 15)
					{
						if (base.npc.direction == -1)
						{
							...
							int damage = 11;
							int type = ModContent.ProjectileType<ForestSicklePro2>();
						...
						else
						{
							...
							int damage2 = 9;
							int type2 = ModContent.ProjectileType<ForestSicklePro2>();
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/PreHM/EbonNymphHop");
			Texture2D slashAni = base.mod.GetTexture("NPCs/PreHM/EbonNymphSlash");
