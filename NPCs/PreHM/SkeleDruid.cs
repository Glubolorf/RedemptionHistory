...
namespace Redemption.NPCs.PreHM
{
	public class SkeleDruid : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			this.bannerItem = ModContent.ItemType<SkeleDruidBanner>();
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SkeleDruidGore1"), 1f);
		...
		public override void AI()
		{
			...
			if (!Main.LocalPlayer.GetModPlayer<RedePlayer>().skeletonFriendly)
			{
				...
				if (base.npc.ai[0] >= 245f)
				{
					...
					int damage = 4;
					int type = ModContent.ProjectileType<GloomShroomSpore1>();
