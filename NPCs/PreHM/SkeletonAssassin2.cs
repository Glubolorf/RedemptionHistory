...
namespace Redemption.NPCs.PreHM
{
	public class SkeletonAssassin2 : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (this.stabAttack)
			{
				...
				if (this.stabTimer == 6)
				{
					...
					{
						int p = Projectile.NewProjectile(base.npc.position.X + -14f, base.npc.position.Y + 28f, 0f, 0f, ModContent.ProjectileType<DamagePro>(), 22, 3f, 255, 0f, 0f);
						Main.projectile[p].netUpdate = true;
						Main.PlaySound(SoundID.Item19, (int)base.npc.position.X, (int)base.npc.position.Y);
					}
					else
					{
						int p2 = Projectile.NewProjectile(base.npc.position.X + 48f, base.npc.position.Y + 28f, 0f, 0f, ModContent.ProjectileType<DamagePro>(), 22, 3f, 255, 0f, 0f);
		...
		public override void NPCLoot()
		{
			...
			{
				Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, ModContent.ItemType<WornDagger>(), 1, false, 0, false, false);
			}
			if (Utils.NextBool(Main.rand, 50))
			{
				Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, ModContent.ItemType<IntruderArmour>(), 1, false, 0, false, false);
			}
			if (Utils.NextBool(Main.rand, 50))
			{
				Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, ModContent.ItemType<IntruderMask>(), 1, false, 0, false, false);
			}
			if (Utils.NextBool(Main.rand, 50))
			{
				Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, ModContent.ItemType<IntruderPants>(), 1, false, 0, false, false);
			}
			if (Utils.NextBool(Main.rand, redePlayer.bloomingLuck ? 400 : 500))
			{
				Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, ModContent.ItemType<Lightbane>(), 1, false, 0, false, false);
			}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SkeleGoreBoneAssassin"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SkeleGoreBoneAssassin"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SkeleGoreBoneAssassin"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SkeleGoreBoneAssassin"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/SkeleGoreBoneAssassin"), 1f);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D stabAni = base.mod.GetTexture("NPCs/PreHM/SkeletonAssassinStab2");
