...
namespace Redemption.NPCs.PreHM
{
	public class UndeadExecutioner1 : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/UndeadExeGore1"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/UndeadExeGore2"), 1f);
		...
		{
			return SpawnCondition.OverworldNightMonster.Chance * (RedeWorld.downedKeeper ? 0.04f : 0f);
		}
