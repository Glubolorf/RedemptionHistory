...
namespace Redemption.NPCs
{
	public class SandskinSpider : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D digAni = base.mod.GetTexture("NPCs/SandskinSpiderDig");
		...
		{
			return SpawnCondition.OverworldDayDesert.Chance * ((!RedeConfigClient.Instance.NoSpidersInMyTerrariaMod) ? 1.8f : 0f);
		}
