...
namespace Redemption.NPCs.Soulless
{
	public class SoullessAssassin : ModNPC
	{
			...
			if (base.npc.velocity.Y == 0f)
			{
				...
				if (this.stabAttack)
				{
					...
					if (this.stabTimer == 24)
					{
						...
						int damage = 55;
						int type = ModContent.ProjectileType<DamagePro>();
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/Soulless/SoullessAssassinHop");
			Texture2D throwAni = base.mod.GetTexture("NPCs/Soulless/SoullessAssassinStab");
