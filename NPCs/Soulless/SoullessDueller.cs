...
namespace Redemption.NPCs.Soulless
{
	public class SoullessDueller : ModNPC
	{
			...
			if (base.npc.velocity.Y == 0f)
			{
				...
				if (this.specialAttack)
				{
					...
					if (this.attackTimer == 35)
					{
						...
						int damage = 55;
						int type = ModContent.ProjectileType<DamagePro2>();
					...
					if (this.attackTimer == 55)
					{
						...
						int damage2 = 55;
						int type2 = ModContent.ProjectileType<DamagePro2>();
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/Soulless/SoullessDuellerHop");
			Texture2D attackAni = base.mod.GetTexture("NPCs/Soulless/SoullessDuellerSlash");
