...
namespace Redemption.NPCs.Soulless
{
	public class TheSoulless2 : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D exoticAni = base.mod.GetTexture("NPCs/Soulless/TheSoulless2_Exotic");
			Texture2D exoticGlow = base.mod.GetTexture("NPCs/Soulless/TheSoulless2_Exotic_Glow");
