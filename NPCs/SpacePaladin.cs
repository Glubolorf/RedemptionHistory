	...
	public class SpacePaladin : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				...
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/SpacePaladinGore4"), 1f);
		...
		{
			return SpawnCondition.OverworldNightMonster.Chance * ((Main.hardMode && NPC.downedPlantBoss && RedeWorld.downedInfectedEye) ? 0.004f : 0f);
		}
	}
}
