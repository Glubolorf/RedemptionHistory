...
namespace Redemption.NPCs.Wasteland
{
	public class InfectedGiantBat : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/InfectedGiantBatGore1"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/InfectedGiantBatGore2"), 1f);
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/InfectedGiantBatGore3"), 1f);
		...
		{
			return SpawnCondition.Cavern.Chance * ((RedeWorld.downedSoI && Main.hardMode) ? 0.025f : 0f);
		}
