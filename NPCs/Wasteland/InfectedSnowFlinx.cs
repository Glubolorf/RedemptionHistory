...
namespace Redemption.NPCs.Wasteland
{
	public class InfectedSnowFlinx : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/Wasteland/InfectedSnowFlinxHop");
			Texture2D fakeDeathAni = base.mod.GetTexture("NPCs/Wasteland/InfectedSnowFlinxFakeDeath");
