...
{
	public class IrradiatedWorldFeederHead : ModNPC
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Irradiated World Feeder");
			Main.npcFrameCount[base.npc.type] = 1;
		}

		public override void SetDefaults()
		{
			base.npc.lifeMax = 325;
			base.npc.damage = 75;
			base.npc.defense = 40;
			...
			base.npc.value = (float)Item.buyPrice(0, 0, 7, 0);
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/Hostile/IrradiatedWorldFeederHeadGore"), 1f);
			}
		}
