...
namespace Redemption.NPCs.Wasteland
{
	public class SneezyInfectedFlinx : ModNPC
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D hopAni = base.mod.GetTexture("NPCs/Wasteland/SneezyInfectedFlinxHop");
			Texture2D buildupAni = base.mod.GetTexture("NPCs/Wasteland/SneezyInfectedFlinxBuildup");
			Texture2D sneezeAni = base.mod.GetTexture("NPCs/Wasteland/SneezyInfectedFlinxSneeze");
