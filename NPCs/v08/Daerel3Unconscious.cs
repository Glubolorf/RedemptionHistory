...
{
	public class Daerel3Unconscious : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (++RedeWorld.daerelDownedTimer >= Main.rand.Next(21600, 57600))
			{
				RedeWorld.daerelDownedTimer = 0;
				base.npc.Transform(base.mod.NPCType("Daerel3"));
				Main.NewText("Daerel the Dark Hunter has woken up!", new Color(45, 114, 233), false);
			}
		}
		...
		public override void OnChatButtonClicked(bool firstButton, ref bool shop)
		{
			...
			if (firstButton)
			{
				...
				if (potion >= 0)
				{
					...
					Main.npcChatText = Daerel3Unconscious.PotionChat();
					return;
				}
				Main.npcChatCornerItem = base.mod.ItemType("RevivalPotion");
				Main.npcChatText = Daerel3Unconscious.NoPotionChat();
			}
		}
