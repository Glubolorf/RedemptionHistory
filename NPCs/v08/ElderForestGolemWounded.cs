...
{
	public class ElderForestGolemWounded : ModNPC
	{
		...
		{
			Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, base.mod.ItemType("LivingTwig"), Main.rand.Next(24, 36), false, 0, false, false);
			...
			Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, 27, Main.rand.Next(2, 4), false, 0, false, false);
			Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, 40, 3, false, 0, false, false);
			if (Main.rand.Next(5) == 0)
			{
				Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, base.mod.ItemType("ForgottenSword"), 1, false, 0, false, false);
			}
		}
		...
		public override void AI()
		{
			...
			{
				this.regenTimer++;
				if (this.regenTimer >= 70 && base.npc.life < base.npc.lifeMax - 5)
				{
					base.npc.life += 5;
			...
			{
				this.regenTimer++;
				if (this.regenTimer >= 60 && base.npc.life < base.npc.lifeMax - 5)
				{
					base.npc.life += 5;
					base.npc.HealEffect(5, true);
					this.regenTimer = 0;
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
		{
			...
			Texture2D texture = base.mod.GetTexture("NPCs/v08/ElderForestGolemWoundedHop");
