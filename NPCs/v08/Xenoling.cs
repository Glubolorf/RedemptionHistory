...
namespace Redemption.NPCs.v08
{
	public class Xenoling : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			this.bannerItem = base.mod.ItemType("XenolingBanner");
		}
		...
		{
			Item.NewItem((int)base.npc.position.X, (int)base.npc.position.Y, base.npc.width, base.npc.height, base.mod.ItemType("Starlite"), Main.rand.Next(1, 5), false, 0, false, false);
