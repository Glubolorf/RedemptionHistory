...
{
	public class Zep3Unconscious : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (++RedeWorld.zephosDownedTimer >= Main.rand.Next(21600, 57600))
			{
				RedeWorld.zephosDownedTimer = 0;
				base.npc.Transform(base.mod.NPCType("Zephos3"));
				Main.NewText("Zephos the Slicer has woken up!", new Color(45, 114, 233), false);
			}
		}
		...
		public override void OnChatButtonClicked(bool firstButton, ref bool shop)
		{
			...
			if (firstButton)
			{
				...
				if (potion >= 0)
				{
					...
					Main.npcChatText = Zep3Unconscious.PotionChat();
					return;
				}
				Main.npcChatCornerItem = base.mod.ItemType("RevivalPotion");
				Main.npcChatText = Zep3Unconscious.NoPotionChat();
			}
		}
