...
namespace Redemption.Projectiles
{
	public class CorruptSoul : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y + 2f), base.projectile.width + 2, base.projectile.height + 2, 198, base.projectile.velocity.X * 0.2f, base.projectile.velocity.Y * 0.2f, 20, default(Color), 1f);
