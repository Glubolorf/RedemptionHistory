...
namespace Redemption.Projectiles
{
	public class CorruptSoul2 : ModProjectile
	{
		...
		{
			int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y + 2f), base.projectile.width + 2, base.projectile.height + 2, 41, base.projectile.velocity.X * 0.2f, base.projectile.velocity.Y * 0.2f, 20, default(Color), 1f);
			...
			if (base.projectile.localAI[0] == 5f)
			{
				for (int i = 0; i < 25; i++)
				{
					int num2 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 41, 0f, 0f, 100, default(Color), 1.2f);
