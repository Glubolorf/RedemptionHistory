	...
	public class CreationRosePetal : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			if (Main.netMode != 2)
			{
				...
				glowMasks[glowMasks.Length - 1] = base.mod.GetTexture("Projectiles/Druid/Seedbag/" + base.GetType().Name);
				CreationRosePetal.customGlowMask = (short)(glowMasks.Length - 1);
		...
		public override void SetDefaults()
		{
			...
			base.projectile.glowMask = CreationRosePetal.customGlowMask;
