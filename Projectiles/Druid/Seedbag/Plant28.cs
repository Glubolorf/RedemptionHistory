...
namespace Redemption.Projectiles.Druid.Seedbag
{
	public class Plant28 : DruidPlant
	{
		...
		protected override void PlantAI()
		{
			...
			if (RedeHelper.ClosestNPC(ref this.target, 800f, base.projectile.Center, false, player.MinionAttackTargetNPC, null) && base.projectile.localAI[0] % 50f == 0f && base.projectile.frame >= 5)
			{
