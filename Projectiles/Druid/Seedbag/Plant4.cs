...
{
	public class Plant4 : DruidPlant
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Vilethorn Bush");
		...
		protected override void PlantAI()
		{
			...
			if (base.projectile.frame > 0)
			{
				...
				if (!this.dustSpawn)
				{
					for (int i = 0; i < 10; i++)
					{
						Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 14, base.projectile.velocity.X * 0.5f, base.projectile.velocity.Y * 0.5f, 0, default(Color), 1f);
					}
					this.dustSpawn = true;
				}
			}
