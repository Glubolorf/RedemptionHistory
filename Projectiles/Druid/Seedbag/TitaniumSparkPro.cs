...
namespace Redemption.Projectiles.Druid.Seedbag
{
	public class TitaniumSparkPro : ModProjectile
	{
		...
		{
			int DustID2 = Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 91, base.projectile.velocity.X * 0.2f, base.projectile.velocity.Y * 0.2f, 20, default(Color), 1f);
