...
{
	public class NatureGuardian16 : Guardian
	{
		...
		public override void SetDefaults()
		{
			...
			this.BuffID = ModContent.BuffType<NatureGuardian16Buff>();
		}
		...
		public override void BirthEffects(Player player)
		{
			...
			Projectile.NewProjectile(player.position, Vector2.Zero, ModContent.ProjectileType<HolyAura>(), 0, 0f, player.whoAmI, 0f, 0f);
		}
