...
{
	public class NatureGuardian7 : Guardian
	{
		...
		public override void SetDefaults()
		{
			...
			this.BuffID = ModContent.BuffType<NatureGuardian7Buff>();
		}
		...
		{
			if (RedeHelper.ClosestNPC(ref this.target, 900f, base.projectile.Center, false, player.MinionAttackTargetNPC, null) && base.projectile.localAI[0] % 90f == 0f)
			{
