...
namespace Redemption.Projectiles.Druid.Stave
{
	public class WorldTree6 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 42f, base.projectile.position.Y + 72f), base.projectile.velocity, ModContent.ProjectileType<FreezeForcePro1>(), base.projectile.damage, 0f, base.projectile.owner, (float)base.projectile.whoAmI, 0f);
			}
