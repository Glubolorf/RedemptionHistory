...
namespace Redemption.Projectiles.DruidProjectiles.Plants
{
	public class CloudNightshade3 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.Center.X + (float)Main.rand.Next(-26, 26), base.projectile.Center.Y + (float)Main.rand.Next(-6, 6)), new Vector2(0f, 0f), base.mod.ProjectileType("CloudNightshadeRain"), 11, 3f, base.projectile.owner, 0f, 0f);
			}
		}
