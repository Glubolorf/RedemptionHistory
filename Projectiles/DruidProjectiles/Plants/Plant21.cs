...
namespace Redemption.Projectiles.DruidProjectiles.Plants
{
	public class Plant21 : DruidPlant
	{
		...
		protected override void PlantAI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.Center.X, base.projectile.Center.Y), base.projectile.velocity, base.mod.ProjectileType("PollenCloud10"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 0f);
			}
		}
