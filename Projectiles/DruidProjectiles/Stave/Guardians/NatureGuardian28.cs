...
{
	public class NatureGuardian28 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!player.HasBuff(ModContent.BuffType<NatureGuardian28Buff>()))
			{
			...
			Lighting.AddLight(base.projectile.Center, (float)(255 - base.projectile.alpha) * 0.1f / 255f, (float)(255 - base.projectile.alpha) * 0.8f / 255f, (float)(255 - base.projectile.alpha) * 1f / 255f);
			base.projectile.position.X = player.Center.X - 21f;
			...
			if (player.dead)
			{
				modPlayer.natureGuardian28 = false;
			}
		}
