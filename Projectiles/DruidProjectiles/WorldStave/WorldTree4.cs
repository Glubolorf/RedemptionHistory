...
{
	public class WorldTree4 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			if (Main.netMode != 2)
			{
				...
				WorldTree4.customGlowMask = (short)(glowMasks.Length - 1);
				Main.glowMaskTexture = glowMasks;
			}
			base.DisplayName.SetDefault("Martian Shield Generator");
		...
		public override void SetDefaults()
		{
			...
			base.projectile.glowMask = WorldTree4.customGlowMask;
		}
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 18f, base.projectile.position.Y + 34f), base.projectile.velocity, ModContent.ProjectileType<MartianForcefieldPro1>(), base.projectile.damage, 0f, base.projectile.owner, (float)base.projectile.whoAmI, 0f);
			}
