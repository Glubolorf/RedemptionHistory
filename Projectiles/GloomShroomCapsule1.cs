...
{
	public class GloomShroomCapsule1 : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			Projectile.NewProjectile(base.projectile.Top, base.projectile.velocity, base.mod.ProjectileType("GloomShroom1"), base.projectile.damage, 0f, base.projectile.owner, 0f, 1f);
			return true;
		}
