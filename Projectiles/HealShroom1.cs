...
{
	public class HealShroom1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 24f, base.projectile.position.Y + 14f), base.projectile.velocity, base.mod.ProjectileType("HealShroomSpores1"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			}
