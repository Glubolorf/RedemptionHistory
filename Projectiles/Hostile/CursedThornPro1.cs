...
{
	public class CursedThornPro1 : ModProjectile
	{
		...
		{
			BaseAI.AIVilethorn(base.projectile, 120, 4, 5);
			this.spineEnd = (base.projectile.ai[1] == 5f);
		...
		public override bool PreDraw(SpriteBatch sb, Color drawColor)
		{
			...
			if (CursedThornPro1.mainTex == null)
			{
				...
				CursedThornPro1.endTex = ModContent.GetTexture("Redemption/Projectiles/CursedThornPro2");
			}
