	...
	public class MACEOrb1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.localAI[0] == 60f)
			{
				...
				Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y + 77f, 0f, 0f, ModContent.ProjectileType<MACEOrbLaser2>(), 40, 3f, 255, 0f, 0f);
			}
		...
		public override void Kill(int timeLeft)
		{
			...
			Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y + 47f, 0f, 0f, ModContent.ProjectileType<MACEOrbLaser1>(), 34, 3f, 255, 0f, 0f);
		}
	}
}
