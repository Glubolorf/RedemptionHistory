	...
	public class IceTentacle : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.scale < 1f)
			{
				...
				{
					int num2 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 135, base.projectile.velocity.X, base.projectile.velocity.Y, 100, default(Color), 1f);
