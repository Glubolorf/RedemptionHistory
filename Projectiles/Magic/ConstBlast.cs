	...
	public class ConstBlast : ModProjectile
	{
		...
		private void drawLaser(SpriteBatch spritebatch, Vector2 centre)
		{
			...
			if (base.projectile.ai[0] > 0f)
			{
				...
				Utils.DrawLaser(spritebatch, base.mod.GetTexture("Projectiles/Magic/ConstBlast_Beam"), start - Main.screenPosition, end - Main.screenPosition, new Vector2(base.projectile.ai[1]), new Utils.LaserLineFraming(this.ConstLaser));
			}
		}
