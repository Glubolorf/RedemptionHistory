...
namespace Redemption.Projectiles.Melee
{
	public class BloodSpearPro1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				int dustID = Dust.NewDust(base.projectile.Center, 0, 0, 235, 0f, 0f, 0, default(Color), 1f);
		...
		public static void AIArcStabSpear(Projectile p, ref float[] ai, bool overrideKill = false)
		{
			...
			BloodSpearPro1.AIArcStabSpear(p, ref ai, plr.Center + gfxOffset, BaseUtility.RotationTo(p.Center, p.Center + p.velocity), plr.direction, plr.itemAnimation, plr.itemAnimationMax, overrideKill, plr.frozen);
		}
