	...
	public class CursedThornFlailPro : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if ((int)base.projectile.ai[1] % 8 == 0 && base.projectile.owner == Main.myPlayer && Main.rand.Next(5) == 0)
			{
				...
				int proj = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, vector15.X, vector15.Y, ModContent.ProjectileType<StingerFriendly>(), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, -10f, 0f);
		...
		{
			Texture2D texture = ModContent.GetTexture("Redemption/Projectiles/Melee/CursedThornFlailPro2");
