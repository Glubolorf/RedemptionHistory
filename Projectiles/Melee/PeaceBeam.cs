...
{
	public class PeaceBeam : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Light Beam");
		}
		...
		public override void AI()
		{
			...
			if (base.projectile.ai[1] >= 80f && this.multiplier == 1)
			{
				this.multiplier = -1;
			}
			...
			Collision.LaserScan(base.projectile.Center, base.projectile.velocity, 0f, 1000f, sampleArray);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Texture2D texture2D20 = base.mod.GetTexture("Projectiles/Melee/PeaceBeam_Beam");
			Texture2D texture2D21 = base.mod.GetTexture("Projectiles/Melee/PeaceBeam_End");
		...
		public const float LaserLengthMax = 1000f;
