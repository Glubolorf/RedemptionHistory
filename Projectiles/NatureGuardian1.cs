...
{
	public class NatureGuardian1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!player.HasBuff(base.mod.BuffType("NatureGuardianBuff")))
			{
			...
			if (player.dead)
			{
				modPlayer.natureGuardian1 = false;
			}
			if (modPlayer.natureGuardian1)
			{
