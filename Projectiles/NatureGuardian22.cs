...
{
	public class NatureGuardian22 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.localAI[0] == 1f)
			{
				for (int i = 0; i < 5; i++)
				{
					int dustIndex = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 55, 0f, 0f, 100, default(Color), 1.2f);
			...
			if (this.shootTimer >= 180)
			{
				...
				{
					Projectile.NewProjectile(new Vector2(base.projectile.position.X + 12f, base.projectile.position.Y + 10f), new Vector2(0f, 0f), base.mod.ProjectileType("SunPulse"), 40, 3f, Main.myPlayer, 0f, 0f);
				}
				else
				{
					Projectile.NewProjectile(new Vector2(base.projectile.position.X + 12f, base.projectile.position.Y + 10f), new Vector2(0f, 0f), base.mod.ProjectileType("SunPulse"), 40, 3f, Main.myPlayer, 0f, 0f);
			...
			if (player.dead)
			{
				modPlayer.natureGuardian22 = false;
			}
		}
