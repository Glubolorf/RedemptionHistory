	...
	public class NatureGuardian23 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.localAI[0] == 1f)
			{
				for (int i = 0; i < 5; i++)
				{
					int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 67, 0f, 0f, 100, default(Color), 1.2f);
			...
			if (this.shootTimer >= 30)
			{
				...
				{
					Projectile.NewProjectile(new Vector2(base.projectile.position.X + 12f, base.projectile.position.Y + 10f), new Vector2(-10f, 0f), 309, 7, 3f, Main.myPlayer, 0f, 0f);
					Projectile.NewProjectile(new Vector2(base.projectile.position.X + 12f, base.projectile.position.Y + 10f), new Vector2(-8f, -2f), 309, 7, 3f, Main.myPlayer, 0f, 0f);
					Projectile.NewProjectile(new Vector2(base.projectile.position.X + 12f, base.projectile.position.Y + 10f), new Vector2(-8f, 2f), 309, 7, 3f, Main.myPlayer, 0f, 0f);
				}
				else
				{
