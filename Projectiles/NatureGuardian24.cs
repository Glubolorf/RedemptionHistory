	...
	public class NatureGuardian24 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.localAI[0] == 1f)
			{
				for (int i = 0; i < 5; i++)
				{
					int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 44, 0f, 0f, 100, default(Color), 1.2f);
			...
			{
				Projectile.NewProjectile(base.projectile.position.X + 12f, base.projectile.position.Y + 10f, (float)(-12 + Main.rand.Next(0, 24)), (float)(-12 + Main.rand.Next(0, 24)), 567, 11, 3f, Main.myPlayer, 0f, 0f);
				this.shootTimer = 0;
			}
