		...
		public override void AI()
		{
			...
			if (this.shootBarrage)
			{
				if (this.shootTimer == 60)
				{
					...
					{
						Projectile.NewProjectile(new Vector2(base.projectile.position.X + 18f, base.projectile.position.Y + 12f), new Vector2(-8f, 0f), base.mod.ProjectileType("CrimsonBlast"), 20, 7f, Main.myPlayer, 0f, 0f);
					}
					else
					{
						Projectile.NewProjectile(new Vector2(base.projectile.position.X + 18f, base.projectile.position.Y + 12f), new Vector2(8f, 0f), base.mod.ProjectileType("CrimsonBlast"), 20, 7f, Main.myPlayer, 0f, 0f);
