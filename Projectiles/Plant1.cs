...
namespace Redemption.Projectiles
{
	public class Plant1 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 14f, base.projectile.position.Y + 10f), base.projectile.velocity, base.mod.ProjectileType("PollenCloud1"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			}
