...
{
	public class Plant10 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 4f, base.projectile.position.Y + 8f), base.projectile.velocity, base.mod.ProjectileType("DeathweedSpike"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			}
			if (base.projectile.localAI[0] == 40f)
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 28f, base.projectile.position.Y + 14f), base.projectile.velocity, base.mod.ProjectileType("DeathweedSpike"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			}
