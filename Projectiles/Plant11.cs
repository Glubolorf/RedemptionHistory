...
{
	public class Plant11 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 36f, base.projectile.position.Y + 18f), base.projectile.velocity, base.mod.ProjectileType("FlyPro"), 4, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			}
			if (base.projectile.localAI[0] == 60f)
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 36f, base.projectile.position.Y + 18f), base.projectile.velocity, base.mod.ProjectileType("PollenCloud4"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			}
