...
{
	public class Plant22 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 15f, base.projectile.position.Y + 11f), base.projectile.velocity, base.mod.ProjectileType("SporeFlowerAura"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			}
