...
{
	public class Plant9 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(new Vector2(base.projectile.position.X + 12f, base.projectile.position.Y + 8f), base.projectile.velocity, base.mod.ProjectileType("PollenCloud3"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 1f);
			}
