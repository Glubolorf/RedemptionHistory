...
{
	public class FreedomStarNPro : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			if (base.projectile.owner == Main.myPlayer)
			{
				...
				case 0:
					...
					Projectile.NewProjectile(vector2.X, vector2.Y, SpeedX, SpeedY, ModContent.ProjectileType<FreedomShotN>(), base.projectile.damage, 1f, player.whoAmI, 0f, 0f);
					return;
				case 1:
					Main.PlaySound(2, (int)base.projectile.position.X, (int)base.projectile.position.Y, 89, 1f, 0f);
					Projectile.NewProjectile(vector2.X, vector2.Y, SpeedX, SpeedY, ModContent.ProjectileType<FreedomShotN>(), base.projectile.damage * 2, 1f, player.whoAmI, 0f, 0f);
					return;
				case 2:
				...
				case 3:
					Main.PlaySound(2, (int)base.projectile.position.X, (int)base.projectile.position.Y, 88, 1f, 0f);
					Projectile.NewProjectile(vector2.X, vector2.Y, SpeedX, SpeedY, ModContent.ProjectileType<FreedomShotNCharged>(), base.projectile.damage * 6, 1f, player.whoAmI, 0f, 0f);
					break;
				default:
					return;
				}
