...
{
	public class XenoShard5 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			if (Main.netMode != 2)
			{
				...
				glowMasks[glowMasks.Length - 1] = base.mod.GetTexture("Projectiles/Ranged/" + base.GetType().Name);
				XenoShard5.customGlowMask = (short)(glowMasks.Length - 1);
				Main.glowMaskTexture = glowMasks;
			}
			base.DisplayName.SetDefault("Xenium Rail Blast");
		}
		...
		public override void SetDefaults()
		{
			...
			base.projectile.glowMask = XenoShard5.customGlowMask;
		}
