...
{
	public class Seed11 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Corpse Flower Seed");
		}
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			Projectile.NewProjectile(base.projectile.Top, base.projectile.velocity, base.mod.ProjectileType("Plant11"), base.projectile.damage, 0f, base.projectile.owner, 0f, 1f);
			return true;
		}
