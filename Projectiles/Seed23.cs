...
{
	public class Seed23 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Adamantite Seed");
		}
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			Projectile.NewProjectile(base.projectile.Top, base.projectile.velocity, base.mod.ProjectileType("Plant25"), base.projectile.damage, 0f, base.projectile.owner, 0f, 1f);
			return true;
		}
