...
namespace Redemption.Projectiles
{
	public class Seed25 : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i < 5; i++)
			{
				int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 35, 0f, 0f, 100, default(Color), 1.2f);
