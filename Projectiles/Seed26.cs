...
{
	public class Seed26 : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			Projectile.NewProjectile(base.projectile.Top, base.projectile.velocity, base.mod.ProjectileType("Plant27"), base.projectile.damage, 2f, base.projectile.owner, 0f, 1f);
			return true;
		}
	}
}
