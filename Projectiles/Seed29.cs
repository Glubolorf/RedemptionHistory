...
{
	public class Seed29 : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Nightshade Seed");
		}
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			Projectile.NewProjectile(base.projectile.Top, base.projectile.velocity, base.mod.ProjectileType("Plant30"), base.projectile.damage, 0f, base.projectile.owner, 0f, 1f);
			return true;
		}
