...
namespace Redemption.Projectiles
{
	public class Seed3 : ModProjectile
	{
		...
		{
			base.DisplayName.SetDefault("Blinkroot Seed");
		}
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			Projectile.NewProjectile(base.projectile.Top, base.projectile.velocity, base.mod.ProjectileType("Plant3"), base.projectile.damage, 0f, base.projectile.owner, 0f, 1f);
			return true;
		}
