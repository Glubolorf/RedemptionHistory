...
namespace Redemption.Projectiles
{
	public class TheKeeperPro : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int num = 8;
			int num2 = Dust.NewDust(new Vector2(base.projectile.position.X + (float)num + 6f, base.projectile.position.Y + (float)num), base.projectile.width - num * 2, base.projectile.height - num * 2, 66, 0f, 0f, 0, new Color(131, 0, 0), 1.5f);
