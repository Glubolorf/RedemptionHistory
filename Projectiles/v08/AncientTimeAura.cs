...
namespace Redemption.Projectiles.v08
{
	public class AncientTimeAura : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(base.projectile.Center, RedeHelper.PolarVector(10f, Utils.ToRotation(this.target.Center - base.projectile.Center)), ModContent.ProjectileType<SunshardSpark>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, 0f, 0f);
			}
		}
