...
namespace Redemption.Projectiles.v08
{
	public class BloodBoltPro1 : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int index2 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 235, 0f, 0f, 100, default(Color), 1f);
