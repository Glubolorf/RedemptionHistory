...
namespace Redemption.Projectiles.v08
{
	public class BloodYoyoPro : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)(-12 + Main.rand.Next(0, 25)), (float)(-12 + Main.rand.Next(0, 25)), base.mod.ProjectileType("BloodOrbPro1"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
		}
	}
}
