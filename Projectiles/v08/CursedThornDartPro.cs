...
namespace Redemption.Projectiles.v08
{
	public class CursedThornDartPro : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			{
				int projID = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<CursedThornDartPro>(), base.projectile.damage - 50, 3f, Main.myPlayer, 0f, 0f);
