	...
	public class CursedThornFlailPro : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if ((int)base.projectile.ai[1] % 8 == 0 && base.projectile.owner == Main.myPlayer && Main.rand.Next(5) == 0)
			{
				...
				int num5 = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, vector3.X, vector3.Y, 55, base.projectile.damage, base.projectile.knockBack, base.projectile.owner, -10f, 0f);
				Main.projectile[num5].hostile = false;
				Main.projectile[num5].friendly = true;
				Main.projectile[num5].timeLeft = 60;
			}
		}
		...
		{
			Texture2D texture = ModLoader.GetTexture("Redemption/Projectiles/v08/CursedThornFlailPro2");
