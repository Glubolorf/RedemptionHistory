...
namespace Redemption.Projectiles.v08
{
	public class EtherealChickenPro : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int num = Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 242, base.projectile.velocity.X * 0.5f, base.projectile.velocity.Y * 0.5f, 0, default(Color), 1f);
