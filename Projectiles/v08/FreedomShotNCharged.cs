...
namespace Redemption.Projectiles.v08
{
	public class FreedomShotNCharged : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			int num = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, 0f, 0f, base.mod.ProjectileType("DummyExplosionFreedom"), base.projectile.damage, 0f, Main.myPlayer, 0f, 0f);
			Main.projectile[num].magic = false;
			Main.projectile[num].ranged = true;
			for (int i = 0; i < 30; i++)
			{
