...
{
	public class Plant31 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)(-12 + Main.rand.Next(0, 24)), (float)(-12 + Main.rand.Next(0, 14)), base.mod.ProjectileType("IchorSpit"), 1, 0f, base.projectile.owner, 0f, 1f);
			}
