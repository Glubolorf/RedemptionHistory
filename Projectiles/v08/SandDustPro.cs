...
namespace Redemption.Projectiles.v08
{
	public class SandDustPro : ModProjectile
	{
		...
		{
			int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 32, 0f, 0f, 100, default(Color), 3f);
