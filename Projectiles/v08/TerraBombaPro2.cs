...
{
	internal class TerraBombaPro2 : ModProjectile
	{
			...
			for (int k = i - size; k <= i + size; k++)
			{
				for (int l = j - size; l <= j + size; l++)
				{
					if (WorldGen.InWorld(k, l, 1) && (double)(Math.Abs(k - i) + Math.Abs(l - j)) < Math.Sqrt((double)(size * size + size * size)))
					{
						...
						if (WallID.Sets.Conversion.Grass[wall] && wall != 65 && wall != 63 && wall != 64)
						{
							Main.tile[k, l].wall = 63;
							WorldGen.SquareWallFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1, 0);
						}
						else if (WallID.Sets.Conversion.Stone[wall] && wall != 1)
						{
						...
						if (TileID.Sets.Conversion.Grass[type] && type != 2 && type != 60)
						{
							Main.tile[k, l].type = 2;
							WorldGen.SquareTileFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1, 0);
						}
						else if (TileID.Sets.Conversion.Stone[type] || type == 179 || type == 180 || type == 181 || type == 182 || type == 183)
						{
							Main.tile[k, l].type = 1;
							WorldGen.SquareTileFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1, 0);
						}
						else if (type == 23 || type == 109 || type == 199)
						{
							Main.tile[k, l].type = 2;
							WorldGen.SquareTileFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1, 0);
						}
						else if (type == 234 || type == 112 || type == 116)
						{
						...
						else if (type == 403 || type == 401 || type == 400)
						{
							Main.tile[k, l].type = 396;
							WorldGen.SquareTileFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1, 0);
						}
						else if (type == 402 || type == 399 || type == 398)
						{
