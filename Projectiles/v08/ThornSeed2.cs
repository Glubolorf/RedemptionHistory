...
namespace Redemption.Projectiles.v08
{
	public class ThornSeed2 : ModProjectile
	{
		...
		{
			int num = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y - 36f, 0f, 0f, base.mod.ProjectileType("BigThorns"), base.projectile.damage, 1f, base.projectile.owner, 0f, 0f);
