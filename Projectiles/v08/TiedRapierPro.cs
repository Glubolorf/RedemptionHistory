...
namespace Redemption.Projectiles.v08
{
	public class TiedRapierPro : ModProjectile
	{
		...
		public static void AIArcStabSpear(Projectile p, ref float[] ai, bool overrideKill = false)
		{
			...
			TiedRapierPro.AIArcStabSpear(p, ref ai, player.Center + vector, BaseUtility.RotationTo(p.Center, p.Center + p.velocity), player.direction, player.itemAnimation, player.itemAnimationMax, overrideKill, player.frozen);
		}
