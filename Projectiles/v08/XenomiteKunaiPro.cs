...
{
	public class XenomiteKunaiPro : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			if (Main.netMode != 2)
			{
				...
				XenomiteKunaiPro.customGlowMask = (short)(glowMasks.Length - 1);
		...
		public override void SetDefaults()
		{
			...
			base.projectile.glowMask = XenomiteKunaiPro.customGlowMask;
		}
