...
namespace Redemption.Tiles.Banners
{
	public class BloatedGoldfishBannerTile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<BloatedGoldfishBanner>(), 1, false, 0, false, false);
		}
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			if (closer)
			{
				...
				localPlayer.NPCBannerBuff[ModContent.NPCType<BloatedGoldfish>()] = true;
