...
namespace Redemption.Tiles.Banners
{
	public class PrototypeSilverBannerTile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<PrototypeSilverBanner>(), 1, false, 0, false, false);
		}
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			if (closer)
			{
				...
				localPlayer.NPCBannerBuff[ModContent.NPCType<PrototypeSilver>()] = true;
