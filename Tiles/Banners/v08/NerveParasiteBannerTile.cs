...
namespace Redemption.Tiles.Banners.v08
{
	public class NerveParasiteBannerTile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<NerveParasiteBanner>(), 1, false, 0, false, false);
		}
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			if (closer)
			{
				...
				localPlayer.NPCBannerBuff[ModContent.NPCType<NerveParasite>()] = true;
