...
{
	public class ShadeChestTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Shade Chest");
			base.AddMapEntry(new Color(70, 90, 100), name, new Func<string, int, int, string>(this.MapChestName));
			...
			this.chest = "Shade Chest";
			this.chestDrop = ModContent.ItemType<ShadeChest>();
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.showItemIconText = ((Main.chest[chest].name.Length > 0) ? Main.chest[chest].name : "Shade Chest");
				if (player.showItemIconText == "Shade Chest")
				{
					player.showItemIcon2 = ModContent.ItemType<ShadeChest>();
