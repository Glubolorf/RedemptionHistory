...
namespace Redemption.Tiles.Furniture.AncientWood
{
	public class AncientWoodDoorOpen : ModTile
	{
		public override void SetDefaults()
		{
			...
			this.closeDoorID = ModContent.TileType<AncientWoodDoorClosed>();
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			localPlayer.showItemIcon2 = ModContent.ItemType<AncientWoodDoor>();
		}

		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(i * 16, j * 16, 32, 48, ModContent.ItemType<AncientWoodDoor>(), 1, false, 0, false, false);
		}
	}
}
