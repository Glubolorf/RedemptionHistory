...
{
	public class DeadWoodChandelierTile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 32, ModContent.ItemType<DeadWoodChandelier>(), 1, false, 0, false, false);
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(base.mod.GetTexture("Tiles/Furniture/DeadWood/DeadWoodChandelierTile_Glow"), new Vector2((float)(i * 16 - (int)Main.screenPosition.X), (float)(j * 16 - (int)Main.screenPosition.Y)) + zero, new Rectangle?(new Rectangle((int)tile.frameX, (int)tile.frameY, 16, height)), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
		}
	}
}
