...
{
	public class ShadeCandelabraTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Shade Candelabra");
		...
		{
			Item.NewItem(i * 16, j * 16, 32, 16, ModContent.ItemType<ShadeCandelabra>(), 1, false, 0, false, false);
		}
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(base.mod.GetTexture("Tiles/Furniture/Shade/ShadeCandelabraTile_Glow"), new Vector2((float)(i * 16 - (int)Main.screenPosition.X), (float)(j * 16 - (int)Main.screenPosition.Y)) + zero, new Rectangle?(new Rectangle((int)tile.frameX, (int)tile.frameY, 16, height)), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
		}
	}
}
