...
{
	public class ShadePortcullisOpen : ModTile
	{
		...
		public override void HitWire(int i, int j)
		{
			...
			WorldGen.PlaceObject(i, j, ModContent.TileType<ShadePortcullisClose>(), false, 0, 0, -1, -1);
			NetMessage.SendObjectPlacment(-1, i, j, ModContent.TileType<ShadePortcullisClose>(), 0, 0, -1, -1);
			if (Wiring.running)
			{
