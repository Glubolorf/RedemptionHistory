...
{
	public class BehemothSummon : ModTile
	{
		...
		{
			if (Main.netMode != 1 && !NPC.AnyNPCs(base.mod.NPCType("IrradiatedBehemoth")) && RedeWorld.downedStage2Scientist && RedeWorld.downedStage3Scientist)
			{
