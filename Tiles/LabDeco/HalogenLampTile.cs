...
namespace Redemption.Tiles.LabDeco
{
	public class HalogenLampTile : ModTile
	{
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(base.mod.GetTexture("Tiles/LabDeco/HalogenLampTile_Glow"), new Vector2((float)(i * 16 - (int)Main.screenPosition.X), (float)(j * 16 - (int)Main.screenPosition.Y)) + zero, new Rectangle?(new Rectangle((int)tile.frameX, (int)tile.frameY, 16, num)), Color.White, 0f, Vector2.Zero, 1f, 0, 0f);
		}
