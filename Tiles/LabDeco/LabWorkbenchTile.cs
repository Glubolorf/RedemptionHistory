...
namespace Redemption.Tiles.LabDeco
{
	public class LabWorkbenchTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			modTranslation.SetDefault("Lab Workbench");
			base.AddMapEntry(new Color(210, 205, 210), modTranslation);
			this.dustType = 226;
		...
		{
			Item.NewItem(i * 16, j * 16, 32, 16, base.mod.ItemType("LabWorkbench"), 1, false, 0, false, false);
		}
	}
}
