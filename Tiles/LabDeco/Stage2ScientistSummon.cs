...
namespace Redemption.Tiles.LabDeco
{
	public class Stage2ScientistSummon : ModTile
	{
		...
		public override void RightClick(int i, int j)
		{
			if (Main.netMode == 0)
			{
				if (!NPC.AnyNPCs(base.mod.NPCType("Stage2ScientistBoss")) && (!RedeWorld.labAccess1 || RedeWorld.downedPatientZero))
				{
			...
			else if (!NPC.AnyNPCs(base.mod.NPCType("Stage2ScientistBoss")) && (!RedeWorld.labAccess1 || RedeWorld.downedPatientZero))
			{
