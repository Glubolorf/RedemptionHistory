...
{
	internal class KSBoxTile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<KSBox>(), 1, false, 0, false, false);
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			localPlayer.showItemIcon2 = ModContent.ItemType<KSBox>();
		}
	}
}
