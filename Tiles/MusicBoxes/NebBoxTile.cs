...
{
	internal class NebBoxTile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<NebBox>(), 1, false, 0, false, false);
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			localPlayer.showItemIcon2 = ModContent.ItemType<NebBox>();
		}
	}
}
