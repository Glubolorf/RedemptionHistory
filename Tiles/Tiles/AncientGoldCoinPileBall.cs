...
namespace Redemption.Tiles.Tiles
{
	public class AncientGoldCoinPileBall : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			this.tileType = ModContent.TileType<AncientGoldCoinPileTile>();
			this.dustType = 246;
		}
		...
		public override void Kill(int timeLeft)
		{
			if (base.projectile.owner == Main.myPlayer && !base.projectile.noDropItem)
			{
				...
				if (!tile.active())
				{
					...
					{
						Item.NewItem((int)base.projectile.position.X, (int)base.projectile.position.Y, base.projectile.width, base.projectile.height, ModContent.ItemType<AncientGoldCoin>(), 1, false, 0, false, false);
					}
