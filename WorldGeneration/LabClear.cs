...
namespace Redemption.WorldGeneration
{
	public class LabClear : MicroBiome
	{
		public override bool Place(Point origin, StructureMap structures)
		{
			...
			BaseWorldGenTex.GetTexGenerator(inst.GetTexture("WorldGeneration/LabClear"), colorToTile, null, null, null, null, null, null).Generate(origin.X, origin.Y, true, true);
			return true;
		}
	}
}
